...
const customTwMerge = bundleCjsExports.extendTailwindMerge({
    extend: {
        classGroups: {
            'font-size': [
                {
...
export { createEvent as a, forwardCommonHostAttributes as b, customTwMerge as c, findAssignedElementsByTag as f, generateRandId as g, propagateToSlot as p };
//# sourceMappingURL=utils-B2sDCMk6.js.map
