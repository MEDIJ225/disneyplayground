...
const WdprScrollbar = /*@__PURE__*/ proxyCustomElement(class WdprScrollbar extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
        this.scrollChange = createEvent(this, "scrollChange", 7);
        this.positionInitialized = createEvent(this, "positionInitialized", 7);
    }
    scrollContainer;
    scrollContent;
    scrollThumb;
    ...
    static get style() { return ".scrollbar-hide {\n      scrollbar-width: none;\n      -ms-overflow-style: none;\n    }\n    .scrollbar-hide::-webkit-scrollbar {\n      display: none;\n    }"; }
}, [257, "wdpr-scrollbar", {
        "orientation": [1],
        "size": [1],
        "initialPosition": [2, "initial-position"],
        "autoHide": [4, "auto-hide"],
        "hideDelay": [2, "hide-delay"],
        "minThumbSize": [2, "min-thumb-size"],
        "scrollSpeed": [2, "scroll-speed"],
        "smoothScroll": [4, "smooth-scroll"],
        "thumbSize": [32],
        "thumbPosition": [32],
        "isVisible": [32],
        "isHovering": [32],
...
function defineCustomElement() {
    ...
    const components = ["wdpr-scrollbar"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-scrollbar":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprScrollbar);
            }
            break;
    } });
}

export { WdprScrollbar as W, defineCustomElement as d };
//# sourceMappingURL=p-gk-6CO08.js.map
