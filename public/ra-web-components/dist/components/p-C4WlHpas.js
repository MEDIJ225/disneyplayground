...
const WdprWeekHeader = /*@__PURE__*/ proxyCustomElement(class WdprWeekHeader extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement() {
    ...
    const components = ["wdpr-week-header"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-week-header":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprWeekHeader);
            }
            break;
    } });
}

export { WdprWeekHeader as W, defineCustomElement as d };
//# sourceMappingURL=p-C4WlHpas.js.map
