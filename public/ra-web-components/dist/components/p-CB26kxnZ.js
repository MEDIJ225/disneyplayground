...
import { d as defineCustomElement$4 } from './p-QL-JXwKm.js';
...
const WdprDualTextField = /*@__PURE__*/ proxyCustomElement(class WdprDualTextField extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return wdprDualTextFieldCss; }
}, [326, "wdpr-dual-text-field", {
        "leadingInputId": [1, "leading-input-id"],
        "leadingValue": [1025, "leading-value"],
        "leadingLabel": [1, "leading-label"],
        "leadingRequirementIndicator": [1, "leading-requirement-indicator"],
        "trailingInputId": [1, "trailing-input-id"],
        "trailingValue": [1025, "trailing-value"],
        ...
        "disabled": [4],
        "required": [4],
        "leadingName": [1, "leading-name"],
        "trailingName": [1, "trailing-name"],
        "readonly": [4],
        "a11yRole": [1, "a11y-role"],
        "a11yHasPopup": [1, "a11y-has-popup"],
        "a11yControls": [1, "a11y-controls"],
        "a11yExpanded": [1, "a11y-expanded"],
        "a11yAutoComplete": [1, "a11y-auto-complete"],
        "a11yActiveDescendant": [1, "a11y-active-descendant"],
        "a11yDisabled": [1, "a11y-disabled"],
        "a11yRequired": [1, "a11y-required"],
        "a11yDescribedBy": [1, "a11y-described-by"],
        "_internalLeadingInputId": [32],
        "_internalTrailingInputId": [32],
        "_leadingFocused": [32],
        "_trailingFocused": [32],
        "setLeadingFocus": [64],
        "setTrailingFocus": [64]
...
function defineCustomElement() {
    ...
    const components = ["wdpr-dual-text-field", "wdpr-divider", "wdpr-icon-library", "wdpr-inline-message", "wdpr-status-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-dual-text-field":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprDualTextField);
            }
            break;
        case "wdpr-divider":
            if (!customElements.get(tagName)) {
...
export { WdprDualTextField as W, defineCustomElement as d };
//# sourceMappingURL=p-CB26kxnZ.js.map
