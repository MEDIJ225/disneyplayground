...
const WdprButtonBar = /*@__PURE__*/ proxyCustomElement(class WdprButtonBar extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement() {
    ...
    const components = ["wdpr-button-bar"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-button-bar":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprButtonBar);
            }
            break;
    } });
}

export { WdprButtonBar as W, defineCustomElement as d };
//# sourceMappingURL=p-D3S41h7H.js.map
