...
const WdprRadioButton = /*@__PURE__*/ proxyCustomElement(class WdprRadioButton extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
        this.radioSelected = createEvent(this, "radioSelected", 7);
        this.wdprChange = createEvent(this, "wdprChange", 3);
    ...
    getLabelElement() {
        ...
        if (!hasContent)
            return null;
        const labelClasses = customTwMerge('body-large select-none', this.disabled ? 'text-text-disabled' : 'text-text-body', this.labelPosition === 'trailing' ? 'ml-150' : 'mr-150');
        return (h("span", { part: "label", class: labelClasses }, h("slot", null, this.label)));
    }
    getAriaLabel() {
    ...
    get radioClasses() {
        ...
        return customTwMerge(radioBaseClasses, radioFocusClasses, radioRadiusClasses, radioCursorClasses, radioHoverClasses, radioPressedClasses);
    }
    get radioCircleClasses() {
        ...
        return customTwMerge(circleBaseClasses, circleDisabledClasses, circleHoverActiveClasses, circleSelectedClasses, circleSelectedDisabledClasses);
    }
    get radioInnerCircleClasses() {
        ...
        return customTwMerge(circleInnerBaseClasses, circleInnerSelectedClasses, circleInnerDisabledClasses);
    }
    render() {
        const labelEl = this.getLabelElement();
        const ariaLabel = this.getAriaLabel();
        return (h("div", { key: 'fbf43d6fa6fce3fe47c065c6d23a4c3759e4dd8f', "aria-label": ariaLabel, "aria-checked": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', "aria-required": this.required ? 'true' : 'false', class: this.radioClasses, onClick: this.onClick, onBlur: this.onBlur, role: "radio" }, this.labelPosition === 'leading' ? labelEl : null, h("span", { key: '755a2485b9c714fbf3da8befef62b74af728133d', class: this.radioCircleClasses }, h("span", { key: '3ef551d0ef77c4f9eb71e79abfed5e217358f5e5', class: this.radioInnerCircleClasses })), this.labelPosition === 'trailing' ? labelEl : null));
    }
...
}, [321, "wdpr-radio-button", {
        "label": [1],
        "name": [513],
        "labelPosition": [1, "label-position"],
        "value": [1537],
        "keyboardNavigation": [1540, "keyboard-navigation"],
        "selected": [1540],
        "disabled": [516],
        "focused": [4],
        "required": [516],
        "radioRole": [16, "radio-role"],
        "customAriaLabel": [1, "a11y-label"],
        "radioGroup": [16, "radio-group"],
        "refreshInternals": [64],
        "selectRadio": [64]
    }, undefined, {
        "selected": ["handleSelectedChange"],
...
function defineCustomElement() {
    ...
    const components = ["wdpr-radio-button"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-radio-button":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprRadioButton);
            }
            break;
    } });
}

export { WdprRadioButton as W, defineCustomElement as d };
//# sourceMappingURL=p-DuX_0jwp.js.map
