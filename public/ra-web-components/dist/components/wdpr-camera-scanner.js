...
const WdprCameraScanner$1 = /*@__PURE__*/ proxyCustomElement(class WdprCameraScanner extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["wdpr-camera-scanner"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-camera-scanner":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprCameraScanner$1);
            }
            break;
    } });
}

const WdprCameraScanner = WdprCameraScanner$1;
const defineCustomElement = defineCustomElement$1;

export { WdprCameraScanner, defineCustomElement };
