...
const WdprCardMedium$1 = /*@__PURE__*/ proxyCustomElement(class WdprCardMedium extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["wdpr-card-medium", "wdpr-overlay"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-card-medium":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprCardMedium$1);
            }
            break;
        case "wdpr-overlay":
            if (!customElements.get(tagName)) {
...
const WdprCardMedium = WdprCardMedium$1;
const defineCustomElement = defineCustomElement$1;

export { WdprCardMedium, defineCustomElement };
