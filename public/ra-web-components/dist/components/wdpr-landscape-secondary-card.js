...
import { c as isHigherThanTablet } from './p-B3zeU0l2.js';
import { p as propagateToSlot } from './p-CXZGMLMW.js';
import { d as defineCustomElement$2 } from './p-Df6D6b08.js';

const WdprLandscapeSecondaryCard$1 = /*@__PURE__*/ proxyCustomElement(class WdprLandscapeSecondaryCard extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
}, [257, "wdpr-landscape-secondary-card", {
        "headline": [1],
        "body": [1],
        "src": [1],
        "a11yAlt": [1, "a11y-alt"],
        "avoidButtonResize": [4, "avoid-button-resize"],
        "_buttonSize": [32]
...
function defineCustomElement$1() {
    ...
    const components = ["wdpr-landscape-secondary-card", "wdpr-media"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-landscape-secondary-card":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprLandscapeSecondaryCard$1);
            }
            break;
        case "wdpr-media":
            if (!customElements.get(tagName)) {
...
const WdprLandscapeSecondaryCard = WdprLandscapeSecondaryCard$1;
const defineCustomElement = defineCustomElement$1;

export { WdprLandscapeSecondaryCard, defineCustomElement };
//# sourceMappingURL=wdpr-landscape-secondary-card.js.map
