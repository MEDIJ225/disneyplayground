...
const WdprDropdown$1 = /*@__PURE__*/ proxyCustomElement(class WdprDropdown extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return wdprDropdownCss; }
}, [326, "wdpr-dropdown", {
        "value": [513],
        "mode": [1],
        "label": [1],
...
function defineCustomElement$1() {
    ...
    const components = ["wdpr-dropdown", "wdpr-icon-library", "wdpr-inline-message", "wdpr-radial-loader", "wdpr-status-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-dropdown":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprDropdown$1);
            }
            break;
...
const WdprDropdown = WdprDropdown$1;
const defineCustomElement = defineCustomElement$1;

export { WdprDropdown, defineCustomElement };
