...
const WdprCarousel$1 = /*@__PURE__*/ proxyCustomElement(class WdprCarousel extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    _calculateItemWidth = () => {
        ...
        this._itemWidth = firstItem instanceof H ? firstItem.offsetWidth : 0;
    };
    ...
    static get style() { return wdprCarouselCss; }
}, [257, "wdpr-carousel", {
        "_showNavigationButtons": [32],
        "_atStart": [32],
        "_atEnd": [32]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["wdpr-carousel", "wdpr-icon-button", "wdpr-icon-library", "wdpr-notification-indicator"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-carousel":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprCarousel$1);
            }
            break;
...
const WdprCarousel = WdprCarousel$1;
const defineCustomElement = defineCustomElement$1;

export { WdprCarousel, defineCustomElement };
