...
import { d as defineCustomElement$c } from './p-B0ImOrmz.js';
import { d as defineCustomElement$b } from './p-DS0cKrSV.js';
import { d as defineCustomElement$a } from './p-D3S41h7H.js';
import { d as defineCustomElement$9 } from './p-DajZYVhg.js';
...
import { d as defineCustomElement$4 } from './p-CY_t0laS.js';
...
const WdprDrawer$1 = /*@__PURE__*/ proxyCustomElement(class WdprDrawer extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    _isFocusable(el) {
        if (!(el instanceof H) || !el.isConnected || ((el instanceof HTMLInputElement || el instanceof HTMLButtonElement) && el.disabled))
            return false;
    ...
    static get style() { return wdprDrawerCss; }
}, [257, "wdpr-drawer", {
        "position": [1],
        "isOpen": [1540, "is-open"],
        ...
        "headerColorMode": [513, "header-color-mode"],
        ...
        "controlled": [516],
        "halfStackMaxWidth": [2, "half-stack-max-width"],
        "avatarImageSrc": [1, "avatar-image-src"],
        "showFooter": [4, "show-footer"],
        "initialOpenPercent": [2, "initial-open-percent"],
        "isDragging": [32],
        "visiblePx": [32],
        "startVisiblePx": [32],
        "layoutIsMobile": [32],
...
function defineCustomElement$1() {
    ...
    const components = ["wdpr-drawer", "wdpr-avatar", "wdpr-button", "wdpr-button-bar", "wdpr-button-dock", "wdpr-divider", "wdpr-icon-button", "wdpr-icon-library", "wdpr-notification-indicator", "wdpr-overlay", "wdpr-scrollbar", "wdpr-text-header"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-drawer":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprDrawer$1);
            }
            break;
        case "wdpr-avatar":
            if (!customElements.get(tagName)) {
...
const WdprDrawer = WdprDrawer$1;
const defineCustomElement = defineCustomElement$1;

export { WdprDrawer, defineCustomElement };
//# sourceMappingURL=wdpr-drawer.js.map
