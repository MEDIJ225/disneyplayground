...
const WdprIcon = /*@__PURE__*/ proxyCustomElement(class WdprIcon extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement() {
    ...
    const components = ["wdpr-icon", "wdpr-icon-library", "wdpr-surface-style"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprIcon);
            }
            break;
...
export { WdprIcon as W, defineCustomElement as d };
//# sourceMappingURL=p-CTYL3_rK.js.map
