...
const WdprRadioGroup = /*@__PURE__*/ proxyCustomElement(class WdprRadioGroup extends H {
    get el() { return this; }
    internals;
    defaultValue = null;
    ...
    static get watchers() { return {
        ...
        "required": [516],
        "radioButtons": [32],
        "cardMicroElements": [32]
    }, [[0, "radioSelected", "handleRadioSelect"]], {
        "value": ["handleValueChanged"],
        "disabled": ["handleDisabledChanged"],
        "required": ["handleRequiredChanged"]
    }]);
function defineCustomElement() {
    ...
    const components = ["wdpr-radio-group"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-radio-group":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprRadioGroup);
            }
            break;
    } });
}

export { WdprRadioGroup as W, defineCustomElement as d };
//# sourceMappingURL=p-VsruIb9P.js.map
