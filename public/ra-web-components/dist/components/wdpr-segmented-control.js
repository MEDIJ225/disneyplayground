...
import { d as defineCustomElement$2 } from './p-B1A7g4NW.js';

const WdprSegmentedControl$1 = /*@__PURE__*/ proxyCustomElement(class WdprSegmentedControl extends H {
    get el() { return this; }
    internals;
    /**
    ...
    static get watchers() { return {
...
}, [321, "wdpr-segmented-control", {
        "options": [16],
        "value": [1537],
        "defaultValue": [1, "default-value"],
        "withIcons": [4, "with-icons"],
        "name": [1],
        ...
        "selectedIndex": [32],
        "setFocus": [64]
    }, [[0, "segmentClick", "handleSegmentClick"]], {
        "value": ["valueChanged"],
        "options": ["optionsChanged"],
        "disabled": ["disabledChanged"],
        "name": ["nameChanged"],
...
function defineCustomElement$1() {
    ...
    const components = ["wdpr-segmented-control", "wdpr-icon-library", "wdpr-segment"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-segmented-control":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprSegmentedControl$1);
            }
            break;
...
const WdprSegmentedControl = WdprSegmentedControl$1;
const defineCustomElement = defineCustomElement$1;

export { WdprSegmentedControl, defineCustomElement };
