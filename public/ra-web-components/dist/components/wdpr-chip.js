...
import { d as defineCustomElement$3 } from './p-Df6D6b08.js';
import { d as defineCustomElement$2 } from './p-BOubPl_u.js';

const WdprChip$1 = /*@__PURE__*/ proxyCustomElement(class WdprChip extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get watchers() { return {
        ...
        "a11yExpanded": [1025, "a11y-expanded"],
        "a11yHasPopup": [1, "a11y-haspopup"],
        "a11yPressed": [1, "a11y-pressed"],
        "variant": [1],
        ...
        "leadingSlot": [32],
        "trailingSlot": [32]
    }, [[0, "keydown", "handleKeyDown"], [0, "formreset", "handleFormReset"]], {
        "selected": ["onSelectedChange"],
        "disabled": ["onDisabledChange"]
    }]);
...
function defineCustomElement$1() {
    ...
    const components = ["wdpr-chip", "wdpr-icon-library", "wdpr-media", "wdpr-notification-indicator"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-chip":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprChip$1);
            }
            break;
...
const WdprChip = WdprChip$1;
const defineCustomElement = defineCustomElement$1;

export { WdprChip, defineCustomElement };
