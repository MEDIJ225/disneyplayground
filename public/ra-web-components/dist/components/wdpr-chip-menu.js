...
const WdprChipMenu$1 = /*@__PURE__*/ proxyCustomElement(class WdprChipMenu extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return wdprChipMenuCss; }
}, [262, "wdpr-chip-menu", {
        "value": [513],
        "alignment": [513],
        ...
        "a11yChipLabel": [1, "a11y-chip-label"],
        "a11yListLabel": [1, "a11y-list-label"],
    ...
    }, [[0, "wdprSelect", "handleItemSelect"], [4, "click", "handleDocumentClick"]], {
        "value": ["handleValueChanged"],
        "_selectedValue": ["updateSelectedValue"],
        "_expanded": ["handleExpandedChange"],
        "maxViewableItems": ["handleMaxViewableItemsChange"]
...
function defineCustomElement$1() {
    ...
    const components = ["wdpr-chip-menu", "wdpr-icon-library", "wdpr-inline-message", "wdpr-radial-loader", "wdpr-status-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-chip-menu":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprChipMenu$1);
            }
            break;
...
const WdprChipMenu = WdprChipMenu$1;
const defineCustomElement = defineCustomElement$1;

export { WdprChipMenu, defineCustomElement };
