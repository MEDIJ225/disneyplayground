...
const WdprDualComboboxItem$1 = /*@__PURE__*/ proxyCustomElement(class WdprDualComboboxItem extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return wdprDualComboboxItemCss; }
}, [257, "wdpr-dual-combobox-item", {
        "itemId": [1, "item-id"],
        "value": [1],
        "label": [1],
        "description": [1],
...
function defineCustomElement$1() {
    ...
    const components = ["wdpr-dual-combobox-item", "wdpr-divider"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-dual-combobox-item":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprDualComboboxItem$1);
            }
            break;
        case "wdpr-divider":
            if (!customElements.get(tagName)) {
...
const WdprDualComboboxItem = WdprDualComboboxItem$1;
const defineCustomElement = defineCustomElement$1;

export { WdprDualComboboxItem, defineCustomElement };
