...
import { g as generateRandId, a as createEvent$1 } from './p-CXZGMLMW.js';
...
const WdprTextField = /*@__PURE__*/ proxyCustomElement(class WdprTextField extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return wdprTextFieldCss; }
}, [326, "wdpr-text-field", {
        "inputId": [1, "input-id"],
        "autocomplete": [1],
        "name": [1],
...
function defineCustomElement() {
    ...
    const components = ["wdpr-text-field", "wdpr-icon-library", "wdpr-inline-message", "wdpr-status-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-text-field":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprTextField);
            }
            break;
...
export { WdprTextField as W, defineCustomElement as d };
//# sourceMappingURL=p-BIWD5pdw.js.map
