...
const WdprCheckbox = /*@__PURE__*/ proxyCustomElement(class WdprCheckbox extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return ":host { display: flex; flex-direction: column; align-items: flex-start; min-width: 0; max-width: 100%; box-sizing: border-box; }"; }
}, [321, "wdpr-checkbox", {
        "inputId": [1, "input-id"],
        "name": [513],
        "cycleOnIndeterminateClick": [1, "cycle-on-indeterminate-click"],
        "customTabindex": [2, "custom-tabindex"],
        "label": [513],
        "customAriaLabel": [513, "a11y-label"],
        "customAriaLabelledBy": [513, "a11y-labelledby"],
        ...
        "required": [516],
        "disabled": [516],
        "forceHover": [4, "force-hover"],
        "forceActive": [4, "force-active"],
        "internalId": [32],
        "setFocus": [64]
    }, undefined, {
        "checked": ["handleCheckedChange"],
...
function defineCustomElement() {
    ...
    const components = ["wdpr-checkbox", "wdpr-icon-library", "wdpr-inline-message", "wdpr-status-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-checkbox":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprCheckbox);
            }
            break;
...
export { WdprCheckbox as W, defineCustomElement as d };
//# sourceMappingURL=p-DTaaOZwt.js.map
