...
const WdprProgressIndicator = /*@__PURE__*/ proxyCustomElement(class WdprProgressIndicator extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement() {
    ...
    const components = ["wdpr-progress-indicator"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-progress-indicator":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprProgressIndicator);
            }
            break;
    } });
}

export { WdprProgressIndicator as W, defineCustomElement as d };
//# sourceMappingURL=p-Bv2Pnyso.js.map
