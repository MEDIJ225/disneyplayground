...
import { d as defineCustomElement$6 } from './p-CTYL3_rK.js';
...
const WdprTile$1 = /*@__PURE__*/ proxyCustomElement(class WdprTile extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return wdprTileCss; }
}, [257, "wdpr-tile", {
        "label": [1],
        "disabled": [1540],
        "visualContent": [1, "visual-content"],
        "roleType": [1, "role-type"],
        "iconJustified": [516, "icon-justified"],
        "secondaryLabel": [1, "secondary-label"],
        "iconName": [1, "icon-name"],
        "mediaSrc": [1, "media-src"],
        "orientation": [1],
        "fullWidth": [8, "full-width"],
        "backgroundIcon": [1, "background-icon"],
        "tileId": [1, "tile-id"],
        "showNotificationIcon": [4, "show-notification-icon"],
        "navigationPath": [1, "navigation-path"],
        "a11yLabel": [1, "a11y-label"],
        "a11yIconLabel": [1, "a11y-icon-label"],
        "_hasAvatarGroup": [32],
        "_internalId": [32]
...
function defineCustomElement$1() {
    ...
    const components = ["wdpr-tile", "wdpr-icon", "wdpr-icon-library", "wdpr-media", "wdpr-notification-indicator", "wdpr-surface-style"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-tile":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprTile$1);
            }
            break;
        case "wdpr-icon":
            if (!customElements.get(tagName)) {
...
const WdprTile = WdprTile$1;
const defineCustomElement = defineCustomElement$1;

export { WdprTile, defineCustomElement };
