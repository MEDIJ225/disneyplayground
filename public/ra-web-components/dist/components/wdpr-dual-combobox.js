...
import { d as defineCustomElement$8 } from './p-CB26kxnZ.js';
...
import { d as defineCustomElement$3 } from './p-D4WKm8KI.js';
...
const WdprDualCombobox$1 = /*@__PURE__*/ proxyCustomElement(class WdprDualCombobox extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    componentWillLoad() {
        this._listId = `wdpr-dual-combobox-list-${generateRandId()}`;
        this._updateFormValue();
    }
    componentDidLoad() {
        requestAnimationFrame(() => {
    ...
    _applyFilter() {
        ...
        groups.forEach(async (group) => {
            const groupItems = Array.from(group.querySelectorAll('[data-dual-combobox-item]')).filter(isDualComboboxItemElement);
    ...
    _getAllListItems() {
        if (!this._cachedItems?.length) {
            this._cachedItems = Array.from(this.el?.querySelectorAll('[data-dual-combobox-item]')).filter(isDualComboboxItemElement);
        }
    ...
    _groupLastItems() {
        ...
        for (const group of groupElements) {
            const items = Array.from(group.querySelectorAll('[data-dual-combobox-item]')).filter(isDualComboboxItemElement);
    ...
    _renderList() {
        ...
        return (h("div", { ref: el => (this._listEl = el), class: "listbox", role: "listbox", id: this._listId, tabindex: isScrollable ? 0 : undefined, "aria-label": this.a11yLabel }, h("slot", null)));
    }
    _renderListWrapper() {
        ...
        return (h("div", { class: `dual-combobox-list-container ${listContainerClasses}`, style: { height: this._measuredMaxHeight } }, this._renderList()));
    }
    _renderStatusMessage() {
        ...
        if (!this._expanded)
            return null;
        if (this.isLoading)
            return (h("div", { class: `loading-container ${locationClass}` }, h("wdpr-radial-loader", { size: this.loaderSize, label: this.loadingText, labelPlacement: this.loaderLabelPlacement, showLabel: this.showLoaderLabel })));
        if (isEmpty && !this.isErrorLoading && !this.isLoading)
            return (h("div", { class: `empty-container ${locationClass}` }, h("wdpr-inline-message", { variant: "informational", size: this.emptyTextSize }, this.emptyText)));
        if (this.isErrorLoading && !this.isLoading)
            return (h("div", { class: `error-container ${locationClass}` }, h("wdpr-inline-message", { variant: "error", size: this.errorTextSize }, this.errorText)));
        return null;
    }
    get _isListVisible() {
    ...
    static get style() { return wdprDualComboboxCss; }
}, [326, "wdpr-dual-combobox", {
        "leadingValue": [513, "leading-value"],
        "leadingLabel": [1, "leading-label"],
        "leadingRequirementIndicator": [1, "leading-requirement-indicator"],
        "trailingValue": [513, "trailing-value"],
        "trailingLabel": [1, "trailing-label"],
        "trailingRequirementIndicator": [1, "trailing-requirement-indicator"],
        ...
        "filterMode": [1, "filter-mode"],
        "location": [513],
        "toggleButtonAriaLabelClosed": [1, "toggle-button-aria-label-closed"],
        "toggleButtonAriaLabelOpen": [1, "toggle-button-aria-label-open"],
        ...
        "emptyTextSize": [1, "empty-text-size"],
        "isErrorLoading": [4, "is-error-loading"],
        "errorText": [1, "error-text"],
        "errorTextSize": [1, "error-text-size"],
        "_activeInput": [32],
        "_leadingInputValue": [32],
        "_trailingInputValue": [32],
        "_expanded": [32],
        "_readyToShow": [32],
        "_focusedIndex": [32],
        "_measuredMaxHeight": [32],
        "_activeDescendantId": [32],
        "_selectedValue": [32]
    }, [[0, "wdprSelect", "handleItemSelect"], [4, "click", "handleClickOutside"]], {
        "leadingValue": ["handleControlledValueChange"],
        "trailingValue": ["handleControlledValueChange"],
        "_expanded": ["handleExpandedChange"],
        "maxViewableItems": ["handleMaxViewableItemsChange"],
...
function defineCustomElement$1() {
    ...
    const components = ["wdpr-dual-combobox", "wdpr-divider", "wdpr-dual-text-field", "wdpr-icon-button", "wdpr-icon-library", "wdpr-inline-message", "wdpr-notification-indicator", "wdpr-radial-loader", "wdpr-status-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-dual-combobox":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprDualCombobox$1);
            }
            break;
        case "wdpr-divider":
            if (!customElements.get(tagName)) {
...
const WdprDualCombobox = WdprDualCombobox$1;
const defineCustomElement = defineCustomElement$1;

export { WdprDualCombobox, defineCustomElement, isDualComboboxItemElement as i };
//# sourceMappingURL=wdpr-dual-combobox.js.map
