...
import { d as defineCustomElement$4 } from './p-BxICy2wL.js';
import { d as defineCustomElement$3 } from './p-DmmASxKN.js';
import { d as defineCustomElement$2 } from './p-C4fBhGYt.js';

const WdprDetailedCountdownTimer$1 = /*@__PURE__*/ proxyCustomElement(class WdprDetailedCountdownTimer extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
}, [257, "wdpr-detailed-countdown-timer", {
        "endAt": [2, "end-at"],
        "type": [1],
        "variant": [1],
        "_hours": [32],
...
function defineCustomElement$1() {
    ...
    const components = ["wdpr-detailed-countdown-timer", "wdpr-day-countdown-timer", "wdpr-number-flipper", "wdpr-time-unit"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-detailed-countdown-timer":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprDetailedCountdownTimer$1);
            }
            break;
...
const WdprDetailedCountdownTimer = WdprDetailedCountdownTimer$1;
const defineCustomElement = defineCustomElement$1;

export { WdprDetailedCountdownTimer, defineCustomElement };
//# sourceMappingURL=wdpr-detailed-countdown-timer.js.map
