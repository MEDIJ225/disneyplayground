...
const WdprTextLink = /*@__PURE__*/ proxyCustomElement(class WdprTextLink extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement() {
    ...
    const components = ["wdpr-text-link"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-text-link":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprTextLink);
            }
            break;
    } });
}

export { WdprTextLink as W, defineCustomElement as d };
//# sourceMappingURL=p-Cb7GjcQn.js.map
