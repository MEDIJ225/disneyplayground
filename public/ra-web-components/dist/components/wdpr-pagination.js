...
import { d as defineCustomElement$3 } from './p-MW8he_pX.js';
import { d as defineCustomElement$2 } from './p-BqCTrtTg.js';

const WdprPagination$1 = /*@__PURE__*/ proxyCustomElement(class WdprPagination extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get watchers() { return {
        ...
        "showNavControls": [4, "show-nav-controls"],
        "maxVisibleItems": [2, "max-visible-items"],
        "hidePaginationGroup": [4, "hide-pagination-group"],
        "collapsed": [4],
        "_calculatedMaxVisibleItems": [32]
    }, undefined, {
        "maxVisibleItems": ["handleConfigChange"],
        "showNavControls": ["handleConfigChange"]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["wdpr-pagination", "wdpr-button", "wdpr-icon-library", "wdpr-pagination-item", "wdpr-pagination-readonly"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-pagination":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprPagination$1);
            }
            break;
        case "wdpr-button":
            if (!customElements.get(tagName)) {
...
const WdprPagination = WdprPagination$1;
const defineCustomElement = defineCustomElement$1;

export { WdprPagination, defineCustomElement };
