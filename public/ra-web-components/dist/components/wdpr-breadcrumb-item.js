...
const WdprBreadcrumbItem$1 = /*@__PURE__*/ proxyCustomElement(class WdprBreadcrumbItem extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
        this.truncationClick = createEvent(this, "truncationClick", 7);
    }
    get el() { return this; }
    /**
     * @internal
    ...
    static get style() { return ":host(.hidden) {\n      display: none;\n    }\n    :host([data-first]) {\n      --wdpr-text-link-text-display: none;\n    }\n    @media (min-width: 768px) {\n      :host([data-first]) {\n        --wdpr-text-link-text-display: inline;\n      }\n    }"; }
}, [257, "wdpr-breadcrumb-item", {
        "showTruncation": [516, "show-truncation"],
        "href": [513],
        "target": [513],
        "separator": [516],
        "label": [513],
        ...
        "_first": [32],
        "_last": [32],
        "setFirstBreadcrumb": [64],
        "setLastBreadcrumb": [64]
    }]);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["wdpr-breadcrumb-item", "wdpr-icon-button", "wdpr-icon-library", "wdpr-notification-indicator", "wdpr-text-link"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-breadcrumb-item":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprBreadcrumbItem$1);
            }
            break;
...
const WdprBreadcrumbItem = WdprBreadcrumbItem$1;
const defineCustomElement = defineCustomElement$1;

export { WdprBreadcrumbItem, defineCustomElement };
