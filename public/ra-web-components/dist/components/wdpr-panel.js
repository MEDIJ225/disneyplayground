...
import { d as defineCustomElement$c } from './p-DS0cKrSV.js';
import { d as defineCustomElement$b } from './p-D3S41h7H.js';
import { d as defineCustomElement$a } from './p-DajZYVhg.js';
...
import { d as defineCustomElement$6 } from './p-BOubPl_u.js';
import { d as defineCustomElement$5 } from './p-CY_t0laS.js';
import { d as defineCustomElement$4 } from './p-C3upN3uE.js';
import { d as defineCustomElement$3 } from './p-gk-6CO08.js';
...
const WdprPanel$1 = /*@__PURE__*/ proxyCustomElement(class WdprPanel extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
        ...
        this.panelCloseRequested = createEvent(this, "panelCloseRequested", 7);
    ...
    _getCurrentFocusableFromEvent(e) {
        ...
        const t0 = path[0];
        if (t0 instanceof H && this._focusableEls.includes(t0))
            return t0;
        const inPath = path.find(t => t instanceof H && this._focusableEls.includes(t));
        if (inPath)
            return inPath;
        const root = this.el.getRootNode();
    ...
    static get style() { return wdprPanelCss; }
}, [257, "wdpr-panel", {
        "position": [1],
        "isOpen": [1540, "is-open"],
        ...
        "isCloseable": [1540, "is-closeable"],
        "showBackButton": [1540, "show-back-button"],
        "disableEscClose": [1540, "disable-esc-close"],
        "width": [1],
        "headerBackground": [513, "header-background"],
        "showDivider": [1540, "show-divider"],
        "showElevation": [1540, "show-elevation"],
        "animationMs": [2, "animation-ms"],
        "closeOnBackdrop": [1028, "close-on-backdrop"],
        "controlled": [516],
...
function defineCustomElement$1() {
    ...
    const components = ["wdpr-panel", "wdpr-button", "wdpr-button-bar", "wdpr-button-dock", "wdpr-divider", "wdpr-icon-button", "wdpr-icon-library", "wdpr-notification-indicator", "wdpr-overlay", "wdpr-page-header", "wdpr-scrollbar", "wdpr-text-header"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-panel":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprPanel$1);
            }
            break;
        case "wdpr-button":
            if (!customElements.get(tagName)) {
...
const WdprPanel = WdprPanel$1;
const defineCustomElement = defineCustomElement$1;

export { WdprPanel, defineCustomElement };
