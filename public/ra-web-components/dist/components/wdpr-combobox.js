import { h, F as Fragment, p as proxyCustomElement, H, c as createEvent, d as Host } from './p-BRIGwGQo.js';
import { g as generateRandId } from './p-CXZGMLMW.js';
import { K as KEYBOARD_KEYS } from './p-CgKa3i1r.js';
import { d as defineCustomElement$9 } from './p-BhS_27uI.js';
...
import { d as defineCustomElement$4 } from './p-D4WKm8KI.js';
...
const WdprCombobox$1 = /*@__PURE__*/ proxyCustomElement(class WdprCombobox extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return wdprComboboxCss; }
}, [326, "wdpr-combobox", {
        "value": [513],
        "label": [1],
        ...
        "requirementIndicator": [1, "requirement-indicator"],
        "_expanded": [32],
        "_inputValue": [32],
        "_highlightedChipIndex": [32],
        "_maxVisibleTags": [32],
        "_focusedIndex": [32],
        "_selectedValues": [32],
        "_readyToShow": [32],
    ...
    }, [[0, "wdprSelect", "handleItemSelect"], [4, "click", "handleClickOutside"], [0, "resetform", "handleResetForm"], [2, "focus", "handleTagFocus"]], {
        "value": ["handleValueChanged"],
        "_expanded": ["handleExpandedChange"],
        "maxViewableItems": ["handleMaxViewableItemsChange"],
        "_inputValue": ["handleLeadingInputValueChange"],
...
function defineCustomElement$1() {
    ...
    const components = ["wdpr-combobox", "wdpr-combobox-tag", "wdpr-icon-button", "wdpr-icon-library", "wdpr-inline-message", "wdpr-notification-indicator", "wdpr-radial-loader", "wdpr-status-icon", "wdpr-text-field"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-combobox":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprCombobox$1);
            }
            break;
...
const WdprCombobox = WdprCombobox$1;
const defineCustomElement = defineCustomElement$1;

export { WdprCombobox, defineCustomElement };
//# sourceMappingURL=wdpr-combobox.js.map
