...
import { d as defineCustomElement$2 } from './p-BlwFeWKw.js';

const WdprTooltip$1 = /*@__PURE__*/ proxyCustomElement(class WdprTooltip extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    render() {
        ...
        "tooltipAriaLabel": [1, "tooltip-aria-label"],
        "label": [1],
...
function defineCustomElement$1() {
    ...
    const components = ["wdpr-tooltip", "wdpr-icon-library", "wdpr-info-icon-with-tooltip"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-tooltip":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprTooltip$1);
            }
            break;
...
const WdprTooltip = WdprTooltip$1;
const defineCustomElement = defineCustomElement$1;

export { WdprTooltip, defineCustomElement };
