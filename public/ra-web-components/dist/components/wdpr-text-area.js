...
const WdprTextArea$1 = /*@__PURE__*/ proxyCustomElement(class WdprTextArea extends H {
    _textAreaElement;
    _internals;
    _defaultValue = '';
    constructor() {
        ...
        this.wdprTrailingClick = createEvent(this, "wdprTrailingClick", 7);
    ...
    get _textAreaClasses() {
        return bundleCjsExports.twMerge(textAreaClasses, this._trailingSlot ? 'pr-400' : '');
    }
    render() {
    ...
    static get watchers() { return {
        ...
        "a11yHasPopup": [1, "a11y-haspopup"],
        "a11yControls": [1, "a11y-controls"],
        "a11yExpanded": [1, "a11y-expanded"],
        "a11yAutoComplete": [1, "a11y-autocomplete"],
        "a11yActiveDescendant": [1, "a11y-activedescendant"],
        "a11yDescribedBy": [1, "a11y-describedby"],
        "_internalId": [32],
        "_trailingSlot": [32],
        "setFocus": [64]
    }, [[0, "keydown", "_handleKeyDown"], [0, "clicked", "_handleIconButtonClick"]], {
        "isDisabled": ["_updateDisabledState"],
        "value": ["_handleValueChange"]
    }]);
...
function defineCustomElement$1() {
    ...
    const components = ["wdpr-text-area", "wdpr-icon-library", "wdpr-inline-message", "wdpr-status-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-text-area":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprTextArea$1);
            }
            break;
...
const WdprTextArea = WdprTextArea$1;
const defineCustomElement = defineCustomElement$1;

export { WdprTextArea, defineCustomElement };
