...
const WdprTextHeader = /*@__PURE__*/ proxyCustomElement(class WdprTextHeader extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement() {
    ...
    const components = ["wdpr-text-header"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-text-header":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprTextHeader);
            }
            break;
    } });
}

export { WdprTextHeader as W, defineCustomElement as d };
//# sourceMappingURL=p-YiP2RhPm.js.map
