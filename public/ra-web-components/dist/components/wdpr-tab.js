...
const WdprTab$1 = /*@__PURE__*/ proxyCustomElement(class WdprTab extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return wdprTabCss; }
}, [258, "wdpr-tab", {
        "tabId": [1, "tab-id"],
        "label": [1],
        ...
        "showInactiveBorderBottom": [516, "show-inactive-border-bottom"]
    }]);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["wdpr-tab", "wdpr-icon-library"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-tab":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprTab$1);
            }
            break;
...
const WdprTab = WdprTab$1;
const defineCustomElement = defineCustomElement$1;

export { WdprTab, defineCustomElement };
