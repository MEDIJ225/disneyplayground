import { p as proxyCustomElement, H, f as forceUpdate, h, d as Host } from './p-BRIGwGQo.js';
import { d as defineCustomElement$3 } from './p-B0ImOrmz.js';
import { d as defineCustomElement$2 } from './p-BOubPl_u.js';

const WdprAvatarGroup$1 = /*@__PURE__*/ proxyCustomElement(class WdprAvatarGroup extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return "/* Overlap lives on shadow wrappers so consumer * resets cannot override ::slotted() margins */\n    .group .avatar-wrapper + .avatar-wrapper {\n      margin-inline-start: calc(var(--avatar-overlap, 16px) * -1);\n    }"; }
}, [257, "wdpr-avatar-group", {
...
function defineCustomElement$1() {
    ...
    const components = ["wdpr-avatar-group", "wdpr-avatar", "wdpr-notification-indicator"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-avatar-group":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprAvatarGroup$1);
            }
            break;
        case "wdpr-avatar":
            if (!customElements.get(tagName)) {
...
const WdprAvatarGroup = WdprAvatarGroup$1;
const defineCustomElement = defineCustomElement$1;

export { WdprAvatarGroup, defineCustomElement };
