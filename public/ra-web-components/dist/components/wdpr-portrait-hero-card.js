...
const WdprPortraitHeroCard$1 = /*@__PURE__*/ proxyCustomElement(class WdprPortraitHeroCard extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["wdpr-portrait-hero-card", "wdpr-media"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-portrait-hero-card":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprPortraitHeroCard$1);
            }
            break;
        case "wdpr-media":
            if (!customElements.get(tagName)) {
...
const WdprPortraitHeroCard = WdprPortraitHeroCard$1;
const defineCustomElement = defineCustomElement$1;

export { WdprPortraitHeroCard, defineCustomElement };
//# sourceMappingURL=wdpr-portrait-hero-card.js.map
