...
import { d as defineCustomElement$7 } from './p-DQhbm-Ru.js';
import { d as defineCustomElement$6 } from './p-xvJdrGIb.js';
import { d as defineCustomElement$5 } from './p-6RXpvZTG.js';
import { d as defineCustomElement$4 } from './p-kVH2iNn4.js';
import { d as defineCustomElement$3 } from './p-BdrKNE06.js';
import { d as defineCustomElement$2 } from './p-DJIJz3tl.js';
import { d as defineCustomElement$1 } from './p-D4WKm8KI.js';
...
const WdprMediaPlayer = /*@__PURE__*/ proxyCustomElement(class WdprMediaPlayer extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return wdprMediaPlayerCss; }
}, [257, "wdpr-media-player", {
        "src": [1],
        "poster": [1],
        "captionsSrc": [1, "captions-src"],
        "captionsLang": [1, "captions-lang"],
        "captionsLabel": [1, "captions-label"],
        "autoHideMs": [2, "auto-hide-ms"],
        ...
        "captionsPosition": [1, "captions-position"],
        "loading": [4],
        "_playing": [32],
        "_muted": [32],
        "_currentTime": [32],
        ...
        "_controlIdle": [32],
        "_isVertical": [32]
    }, [[0, "wdprPlayToggle", "onPlayToggle"], [0, "wdprMuteToggle", "onMuteToggle"], [0, "wdprCaptionsToggle", "onCaptionsToggle"], [0, "wdprBarTimeChange", "onProgressBarTimeChange"], [0, "wdprFullscreenToggle", "onFullscreenToggle"]], {
        "playing": ["onPlayingChange"]
    }]);
function defineCustomElement() {
    ...
    const components = ["wdpr-media-player", "wdpr-icon-library", "wdpr-media-player-control", "wdpr-media-player-control-captions-toggle", "wdpr-media-player-control-fullscreen-toggle", "wdpr-media-player-control-mute-toggle", "wdpr-media-player-control-play-toggle", "wdpr-media-player-control-progress-bar", "wdpr-radial-loader"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-media-player":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprMediaPlayer);
            }
            break;
...
export { WdprMediaPlayer as W, defineCustomElement as d };
//# sourceMappingURL=p-DvSpJD8k.js.map
