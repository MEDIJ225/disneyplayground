...
const WdprButtonDockTotal$1 = /*@__PURE__*/ proxyCustomElement(class WdprButtonDockTotal extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["wdpr-button-dock-total"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-button-dock-total":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprButtonDockTotal$1);
            }
            break;
    } });
}

const WdprButtonDockTotal = WdprButtonDockTotal$1;
const defineCustomElement = defineCustomElement$1;

export { WdprButtonDockTotal, defineCustomElement };
