...
const WdprLandscapePrimaryCard$1 = /*@__PURE__*/ proxyCustomElement(class WdprLandscapePrimaryCard extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
}, [257, "wdpr-landscape-primary-card", {
        "headline": [1],
        "body": [1],
        "src": [1],
        "a11yAlt": [1, "a11y-alt"],
...
function defineCustomElement$1() {
    ...
    const components = ["wdpr-landscape-primary-card", "wdpr-media"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-landscape-primary-card":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprLandscapePrimaryCard$1);
            }
            break;
        case "wdpr-media":
            if (!customElements.get(tagName)) {
...
const WdprLandscapePrimaryCard = WdprLandscapePrimaryCard$1;
const defineCustomElement = defineCustomElement$1;

export { WdprLandscapePrimaryCard, defineCustomElement };
