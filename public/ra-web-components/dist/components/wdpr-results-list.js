...
import { d as defineCustomElement$6 } from './p-D4WKm8KI.js';
import { d as defineCustomElement$5 } from './p-Dh8XsW9w.js';
...
const WdprResultsList$1 = /*@__PURE__*/ proxyCustomElement(class WdprResultsList extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["wdpr-results-list", "wdpr-checkbox", "wdpr-divider", "wdpr-icon-library", "wdpr-inline-message", "wdpr-radial-loader", "wdpr-results-list-item", "wdpr-scrollbar", "wdpr-status-icon", "wdpr-surface-style"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-results-list":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprResultsList$1);
            }
            break;
        case "wdpr-checkbox":
            if (!customElements.get(tagName)) {
...
const WdprResultsList = WdprResultsList$1;
const defineCustomElement = defineCustomElement$1;

export { WdprResultsList, defineCustomElement };
