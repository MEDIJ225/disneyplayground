...
const WdprRive$1 = /*@__PURE__*/ proxyCustomElement(class WdprRive extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
        this.wdprLoad = createEvent(this, "wdprLoad", 7);
        this.wdprError = createEvent(this, "wdprError", 7);
        this.wdprPlay = createEvent(this, "wdprPlay", 7);
        this.wdprPause = createEvent(this, "wdprPause", 7);
        this.wdprStop = createEvent(this, "wdprStop", 7);
        this.wdprStateChange = createEvent(this, "wdprStateChange", 7);
    }
    _canvasEl;
    _riveInstance = null;
    ...
    static get watchers() { return {
        ...
        "getRiveInstance": [64],
        "getModelInstance": [64],
        "getStateMachineInputs": [64],
        "getViewModelProperties": [64],
        "getTextRunValue": [64],
        "setTextRunValue": [64],
        "getViewModelValue": [64],
        "setViewModelValue": [64]
    }, undefined, {
        "src": ["handleSrcChange"],
        "animation": ["handleAnimationChange"],
        "stateMachine": ["handleAnimationChange"],
...
function defineCustomElement$1() {
    ...
    const components = ["wdpr-rive"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-rive":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprRive$1);
            }
            break;
    } });
}

const WdprRive = WdprRive$1;
const defineCustomElement = defineCustomElement$1;

export { WdprRive, defineCustomElement };
