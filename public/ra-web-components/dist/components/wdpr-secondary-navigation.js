...
const WdprSecondaryNavigation$1 = /*@__PURE__*/ proxyCustomElement(class WdprSecondaryNavigation extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["wdpr-secondary-navigation", "wdpr-divider", "wdpr-icon-button", "wdpr-icon-library", "wdpr-notification-indicator"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-secondary-navigation":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprSecondaryNavigation$1);
            }
            break;
        case "wdpr-divider":
            if (!customElements.get(tagName)) {
...
const WdprSecondaryNavigation = WdprSecondaryNavigation$1;
const defineCustomElement = defineCustomElement$1;

export { WdprSecondaryNavigation, defineCustomElement };
