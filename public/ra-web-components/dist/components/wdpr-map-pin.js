import { h, p as proxyCustomElement, H, c as createEvent } from './p-BRIGwGQo.js';
import { c as customTwMerge } from './p-CXZGMLMW.js';
import { d as defineCustomElement$2 } from './p-CiDhVxgt.js';

const SelectedPinSvg = () => (h("svg", { width: "56", height: "60", viewBox: "0 0 56 60", class: "absolute inset-0 transition-colors duration-200", fill: "currentColor", xmlns: "http://www.w3.org/2000/svg" },
    h("g", { filter: "url(#filter0_f_88956_309)" },
        h("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M31.4328 55.9999C31.4328 55.9999 6.19234 50.0931 4.13762 46.3501C2.0829 42.607 23.6441 41.651 28.2257 48.8255C32.8074 55.9999 31.4328 55.9999 31.4328 55.9999Z", fill: "#445582", "fill-opacity": "0.3" })),
    h("path", { d: "M55.7477 23.6761C55.7492 23.5676 55.75 23.4589 55.75 23.35C55.75 10.4542 45.0048 0 31.75 0C18.4952 0 7.75 10.4542 7.75 23.35C7.75 23.4589 7.75077 23.5676 7.75229 23.6761C7.75077 23.7484 7.75 23.8209 7.75 23.8937C7.75 42.1359 31.75 56 31.75 56C31.75 56 55.75 42.1359 55.75 23.8937C55.75 23.8209 55.7492 23.7484 55.7477 23.6761Z", fill: "currentColor" }),
    h("defs", null,
        h("filter", { id: "filter0_f_88956_309", x: "0", y: "39.4736", width: "35.626", height: "20.5264", filterUnits: "userSpaceOnUse", "color-interpolation-filters": "sRGB" },
            ...
            h("feGaussianBlur", { stdDeviation: "2", result: "effect1_foregroundBlur_88956_309" })))));
const UnselectedPinSvg = () => (h("svg", { width: "43", height: "48", class: "absolute inset-0 transition-colors duration-200", viewBox: "0 0 43 48", fill: "currentColor", xmlns: "http://www.w3.org/2000/svg" },
    h("g", { filter: "url(#filter0_f_88936_19)" },
        h("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M24.5746 44.0001C24.5746 44.0001 5.64426 39.359 4.10322 36.418C2.56218 33.4771 18.7331 32.7259 22.1693 38.363C25.6055 44.0001 24.5746 44.0001 24.5746 44.0001Z", fill: "#445582", "fill-opacity": "0.3" })),
    h("path", { d: "M42.8108 18.6026C42.8119 18.5174 42.8125 18.432 42.8125 18.3464C42.8125 8.21399 34.7536 0 24.8125 0C14.8714 0 6.8125 8.21399 6.8125 18.3464C6.8125 18.432 6.81308 18.5174 6.81422 18.6026C6.81308 18.6594 6.8125 18.7164 6.8125 18.7737C6.8125 33.1068 24.8125 44 24.8125 44C24.8125 44 42.8125 33.1068 42.8125 18.7737C42.8125 18.7164 42.8119 18.6594 42.8108 18.6026Z", fill: "currentColor" }),
    h("defs", null,
        h("filter", { id: "filter0_f_88936_19", x: "0", y: "30.158", width: "28.7195", height: "17.842", filterUnits: "userSpaceOnUse", "color-interpolation-filters": "sRGB" },
            h("feFlood", { "flood-opacity": "0", result: "BackgroundImageFix" }),
            h("feBlend", { mode: "normal", in: "SourceGraphic", in2: "BackgroundImageFix", result: "shape" }),
            h("feGaussianBlur", { stdDeviation: "2", result: "effect1_foregroundBlur_88936_19" })))));

const WdprMapPin$1 = /*@__PURE__*/ proxyCustomElement(class WdprMapPin extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
        this.mapPinClick = createEvent(this, "wdprMapPinClick", 7);
    }
    get el() { return this; }
    styleVariant = 'icon';
    label = 'trailing';
    ...
    render() {
        ...
        "selectedIconName": [1, "selected-icon-name"],
        "time": [2]
    }]);
...
function defineCustomElement$1() {
    ...
    const components = ["wdpr-map-pin", "wdpr-icon-library"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-map-pin":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprMapPin$1);
            }
            break;
...
const WdprMapPin = WdprMapPin$1;
const defineCustomElement = defineCustomElement$1;

export { WdprMapPin, defineCustomElement };
