...
const WdprBreadcrumb$1 = /*@__PURE__*/ proxyCustomElement(class WdprBreadcrumb extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    render() {
        ...
        "wrapMode": [513, "wrap-mode"],
        "_showAll": [32],
        "_ready": [32]
    }, [[0, "truncationClick", "onTruncationClick"]]]);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["wdpr-breadcrumb"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-breadcrumb":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprBreadcrumb$1);
            }
            break;
    } });
}

const WdprBreadcrumb = WdprBreadcrumb$1;
const defineCustomElement = defineCustomElement$1;

export { WdprBreadcrumb, defineCustomElement };
