...
const WdprSegmentedVerticalTab$1 = /*@__PURE__*/ proxyCustomElement(class WdprSegmentedVerticalTab extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return wdprSegmentedVerticalTabCss; }
}, [258, "wdpr-segmented-vertical-tab", {
        "tabId": [1, "tab-id"],
        "label": [1],
...
function defineCustomElement$1() {
    ...
    const components = ["wdpr-segmented-vertical-tab", "wdpr-icon-library"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-segmented-vertical-tab":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprSegmentedVerticalTab$1);
            }
            break;
...
const WdprSegmentedVerticalTab = WdprSegmentedVerticalTab$1;
const defineCustomElement = defineCustomElement$1;

export { WdprSegmentedVerticalTab, defineCustomElement };
