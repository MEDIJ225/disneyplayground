...
const WdprQrcode$1 = /*@__PURE__*/ proxyCustomElement(class WdprQrcode extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return ":host { display: inline-block; }"; }
        ...
        "correctionLevel": [1, "correction-level"],
        "_isLoaded": [32]
    }, undefined, {
        "text": ["handlePropsChange"],
        "size": ["handlePropsChange"],
...
function defineCustomElement$1() {
    ...
    const components = ["wdpr-qrcode"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-qrcode":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprQrcode$1);
            }
            break;
    } });
}

const WdprQrcode = WdprQrcode$1;
const defineCustomElement = defineCustomElement$1;

export { WdprQrcode, defineCustomElement };
