import { p as proxyCustomElement, H, c as createEvent, e as getElement, h, d as Host } from './p-BRIGwGQo.js';
import { p as propagateToSlot, c as customTwMerge } from './p-CXZGMLMW.js';
import { F as FOCUSABLE_SELECTORS } from './p-BruAnD1D.js';

const WdprGhostContainer$1 = /*@__PURE__*/ proxyCustomElement(class WdprGhostContainer extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
        this.wdprGhostContainerClick = createEvent(this, "wdprGhostContainerClick", 7);
    }
    /**
...
function defineCustomElement$1() {
    ...
    const components = ["wdpr-ghost-container"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-ghost-container":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprGhostContainer$1);
            }
            break;
    } });
}

const WdprGhostContainer = WdprGhostContainer$1;
const defineCustomElement = defineCustomElement$1;

export { WdprGhostContainer, defineCustomElement };
