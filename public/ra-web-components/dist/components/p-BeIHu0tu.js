...
const WdprSurfaceStyle = /*@__PURE__*/ proxyCustomElement(class WdprSurfaceStyle extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement() {
    ...
    const components = ["wdpr-surface-style"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-surface-style":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprSurfaceStyle);
            }
            break;
    } });
}

export { WdprSurfaceStyle as W, defineCustomElement as d };
//# sourceMappingURL=p-BeIHu0tu.js.map
