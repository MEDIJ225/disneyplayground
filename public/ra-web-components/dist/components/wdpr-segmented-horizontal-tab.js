...
const WdprSegmentedHorizontalTab$1 = /*@__PURE__*/ proxyCustomElement(class WdprSegmentedHorizontalTab extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return wdprSegmentedHorizontalTabCss; }
}, [258, "wdpr-segmented-horizontal-tab", {
        "tabId": [1, "tab-id"],
        "label": [1],
        "icon": [1],
        "active": [1540],
...
function defineCustomElement$1() {
    ...
    const components = ["wdpr-segmented-horizontal-tab", "wdpr-icon-library"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-segmented-horizontal-tab":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprSegmentedHorizontalTab$1);
            }
            break;
...
const WdprSegmentedHorizontalTab = WdprSegmentedHorizontalTab$1;
const defineCustomElement = defineCustomElement$1;

export { WdprSegmentedHorizontalTab, defineCustomElement };
