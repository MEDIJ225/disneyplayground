...
const WdprToggle$1 = /*@__PURE__*/ proxyCustomElement(class WdprToggle extends H {
    get el() { return this; }
    internals;
    ...
    static get watchers() { return {
        ...
        "value": [1537],
        "required": [4],
        "toggleAriaLabel": [1, "toggle-aria-label"],
        "toggleAriaDescription": [1, "toggle-aria-description"],
        "hasCheckedIcon": [32],
        "hasUncheckedIcon": [32],
        "toggle": [64],
        "setFocus": [64]
...
function defineCustomElement$1() {
    ...
    const components = ["wdpr-toggle"];
    components.forEach(tagName => { switch (tagName) {
        case "wdpr-toggle":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WdprToggle$1);
            }
            break;
    } });
}

const WdprToggle = WdprToggle$1;
const defineCustomElement = defineCustomElement$1;

export { WdprToggle, defineCustomElement };
