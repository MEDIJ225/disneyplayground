...
const WdprPaginationItem = class {
    ...
    render() {
        ...
        return (index.h("button", { key: 'be32e4a1b2c6a75d077a08f13b0772499d15673a', type: "button", class: buttonClasses, onClick: this._handleClick, disabled: this.disabled, "aria-pressed": this.selected ? 'true' : 'false', "data-selected": this.selected ? 'true' : 'false', "aria-label": this.a11yLabel }, index.h("span", { key: '7e49b8b4eca7a8c0d018e96d44250444b86a5678', class: labelClasses }, this.page)));
    }
};
...
const WdprPaginationReadonly = class {
    ...
    render() {
        return (index.h("span", { key: 'df944eac9ff894ae67eb513543e6ab558f4cc01e', class: "w-dimension-500 h-dimension-500 flex items-center justify-center text-color-icon-body" }, index.h("wdpr-icon-library", { key: 'a5dd8b1ba60c6614780c4c4ab4e5283ef78d067e', icon: "more", size: "xsmall", decorative: true })));
    }
};

exports.wdpr_pagination_item = WdprPaginationItem;
exports.wdpr_pagination_readonly = WdprPaginationReadonly;
//# sourceMappingURL=wdpr-pagination-item.wdpr-pagination-readonly.entry.cjs.js.map

//# sourceMappingURL=wdpr-pagination-item_2.cjs.entry.js.map