...
const WdprButton = class {
    ...
    _handleSubmit() {
        ...
        if (typeof this.internals.form?.requestSubmit === 'function') {
            ...
            const submitEvent = utils.createEvent('submit', { bubbles: true, composed: true, cancelable: true });
    ...
    get _labelClass() {
        if (this.variant === 'text-no-padding') {
            ...
            return utils.customTwMerge('truncate', `${leftMargin} ${rightMargin}`.trim());
        }
        return utils.customTwMerge('truncate', `${labelSpacingClasses[this.size].leading} ${labelSpacingClasses[this.size].trailing}`);
    }
    get _buttonClass() {
        return utils.customTwMerge(baseClasses, sizeClasses[this.size], this._layoutClasses, variantClasses[this.variant].default, variantClasses[this.variant].hover, variantClasses[this.variant].focus, variantClasses[this.variant].active, variantClasses[this.variant].disabled);
    }
    ...
    render() {
        return (index.h("button", { key: '2deca549bf29c79403746121009941f9905466ed', type: this.type, disabled: this.disabled, name: this.name, value: this.value, class: this._buttonClass, onClick: this._handleClick, "aria-label": this.a11yLabel || undefined, "aria-disabled": this.disabled ? 'true' : 'false', part: "button" }, index.h("span", { key: '55800a708532456cdbeafc0538a41e18cbc88333', class: this._getLeadingIconClass, "aria-hidden": "true" }, index.h("slot", { key: '4a71dfdea021b09e0ba91912778707131e9d9f85', name: "leading-icon" })), index.h("span", { key: 'aa3d185198b59f5e273d051fc38c6c581c01f9f9', class: this._labelClass }, index.h("slot", { key: 'b56175ba788194a79c6ca95358ef024fe262a573' })), index.h("span", { key: 'e165751b1de50f174568d1707425af0adb4f820c', class: this._getTrailingIconClass, "aria-hidden": "true" }, index.h("slot", { key: 'c72262d5a3525f30fe87b36fdca487baa3e9136a', name: "trailing-icon" }))));
    }
...
exports.wdpr_button = WdprButton;
//# sourceMappingURL=wdpr-button.entry.cjs.js.map

//# sourceMappingURL=wdpr-button.cjs.entry.js.map