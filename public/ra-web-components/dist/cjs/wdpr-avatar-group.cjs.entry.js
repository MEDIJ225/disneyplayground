...
const WdprAvatarGroup = class {
    ...
    _renderOverflow(count) {
        ...
        return (index.h("wdpr-avatar", { "is-overflow": true, "show-border": true, isInteractive: false, text: `+${capped}`, size: this.size }));
    }
    render() {
        const overflowCount = Math.max(0, this._avatars.length - this.maxCount);
        return (index.h(index.Host, { key: 'bae60d3442a857a37625362e1d1d1d218001ba36', style: { '--avatar-overlap': this._overlapToken }, role: "group", "data-v": this._version }, index.h("div", { key: '3c93ac7bc6bc1853f4d9a5c2938e89005dd9c5be', class: this._containerClasses }, this._avatars.slice(0, this.maxCount).map((_, i) => (index.h("div", { class: "avatar-wrapper" }, index.h("slot", { name: `avatar-${i}`, onSlotchange: () => this._syncFromSlot() })))), overflowCount > 0 && index.h("div", { key: '890bebab51eb96084f461913fdf2117c0a0bcda8', class: "avatar-wrapper mb-1" }, this._renderOverflow(overflowCount)))));
    }
...
exports.wdpr_avatar_group = WdprAvatarGroup;
//# sourceMappingURL=wdpr-avatar-group.entry.cjs.js.map

//# sourceMappingURL=wdpr-avatar-group.cjs.entry.js.map