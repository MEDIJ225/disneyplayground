...
const WdprDrawer = class {
    constructor(hostRef) {
        ...
        this.drawerOpened = index.createEvent(this, "drawerOpened", 7);
    ...
    _bodyRef;
    _footerRef;
    _headingId = `wdpr-drawer-h-${utils.generateRandId()}`;
    ...
    get _panelLayoutClasses() {
        if (this._isMobileHalfStack) {
            ...
            return utils.customTwMerge('fixed bottom-0', 'translate-y-full', // JS sets precise transform
    ...
    get _drawerHeaderClasses() {
        ...
        return bundleCjs.bundleCjsExports.twMerge('flex px-300 pb-200', paddingTop, justifyContent);
    }
    get _headerClasses() {
        ...
        if (this.showDivider && this.isBodyScrolled) {
            ...
            return utils.customTwMerge('sticky top-0 border-stroke-neutral-light', this._sideRadiusHeaderClass, this.showElevation ? boxShadow : '', 'flow-root', paddingTop, overflowClass, headerColor);
        }
        return utils.customTwMerge('sticky top-0 border-stroke-neutral-light flow-root', paddingTop, overflowClass, headerColor, this._sideRadiusHeaderClass);
    }
    get _handleClasses() {
        const bgColor = this.headerColorMode === 'secondary' ? 'bg-surface-actionable-alt-focus' : 'bg-surface-neutral-light';
        return bundleCjs.bundleCjsExports.twMerge('rounded-pill w-500 h-050', bgColor);
    }
    get _contentClasses() {
        const color = this.colorMode === 'secondary' ? 'bg-surface-default-alt' : 'bg-surface-default';
        return bundleCjs.bundleCjsExports.twMerge('min-w-0 min-h-0 flex flex-col flex-1 pt-300 overflow-hidden', color);
    }
    _clickPrimary() {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '652a9d77220cdd2346c2ce477d8b7ea14724cf46', style: { '--anim-ms': `${this.animationMs}ms` } }, index.h("wdpr-overlay", { key: 'e22465e93b7e4e73460c05495af95c7c77cb3fec', cover: true, open: this.isOpen, variant: "scrim", role: "presentation", "a11y-label": "Backdrop", onOverlayClick: this._handleOverlayClick }), index.h("div", { key: 'e3df08e851ceeb00834e09b8fa4b4cbf9132ab89', style: {
            ...
            }, class: this._panelLayoutClasses, role: "dialog", "aria-modal": "true", tabIndex: -1, "aria-label": ariaLabel, "aria-labelledby": labelledBy, ref: el => (this._panelRef = el) }, index.h("div", { key: '9b0d4c6b8e6af19aa11545cca7fe04f48ff794da', "data-focus-sentinel": "start", tabIndex: 0, "aria-hidden": "true", class: "sr-only", onFocus: () => this._handleSentinelFocus(true) }), index.h("header", { key: 'ece873e19375037c5ba4f053f12c45db19560615', class: this._headerClasses, part: "header" }, this.isDraggable && this._isMobileHalfStack && !this.avatarImageSrc && (index.h("div", { key: 'e94de38ea5d5fd01f567aa5090a5c4a9914f2791', class: "mx-auto pt-100 pb-250 h-400 w-500", "data-drag-handle": true, onPointerDown: this._onPointerDown }, index.h("div", { key: '8eeecf3c0403332c1f9587c4c8017d1518de675f', class: this._handleClasses }))), this._isMobileHalfStack && this.avatarImageSrc && (index.h("div", { key: 'a594de2fe1237b29b56b93a6698228c732c96241', class: "flex h-400 pt-[34px] flex-col items-center self-stretch", "data-drag-handle": true, onPointerDown: this._onPointerDown }, index.h("div", { key: '4080f4b61d49d929c746d405ff59e9ee3bf7da60', class: "absolute top-[-34px] mx-auto" }, index.h("wdpr-avatar", { key: '93d2161f7068957ff751793a60091712bb270fd4', isInteractive: false, showBorder: true, imageSrc: this.avatarImageSrc, size: "large" })))), index.h("slot", { key: '4870d3bc2e369c00f608026869c4c5856b861c43', name: "drawer-header" }, index.h("div", { key: '6f3512fdc56a362fd1d8e5dfa1bfd96f88fce0ff', class: this._drawerHeaderClasses }, this.showBackButton && index.h("wdpr-icon-button", { key: '86e95ea6b6a16cd15a52be9aa0a44411f631d88a', iconName: "back-thick", a11yLabel: "Back", size: "medium", variant: "primary", onClick: this._handleBackClick }), this.isCloseable && index.h("wdpr-icon-button", { key: '2dd4e5d8181e8bf4df03490a6f59484f262cd7a0', iconName: "close-reversed", a11yLabel: "Close", size: "medium", variant: "primary", onClick: this._handleCloseClick }))), index.h("div", { key: '23d6ecd929f3951c0bc2644d032b7c40f6a5704d', class: "flex flex-col" }, index.h("slot", { key: '14648dff9f966468e816a60ec7b61afbaef9d48c', name: "header" }, index.h("wdpr-text-header", { key: '3c4dccb8b74f2c892185098b2b367e2632c9a862', size: "large", id: this._headingId, class: "px-300", headerLabel: this.titleText, subtextLabel: this.subtitleText }, this.leadingIcon && index.h("wdpr-icon-library", { key: '36cd286a0238b406c858e73dac92069e531c4fa2', size: "medium", icon: this.leadingIcon, slot: "leading-icon", decorative: true }))), index.h("slot", { key: '6062b07590d509918bd93a57352ca1027e5bf7d5', name: "header-content" }), this.showDivider && index.h("div", { key: 'b2047761b49fd7c593e2820378125b1658523a68', class: "mt-200" }, this.isBodyScrolled && index.h("wdpr-divider", { key: '933397f9406c0087768e26c3d5c82951a4618093', orientation: "horizontal" })))), index.h("section", { key: '4b9d75c2d43443c465be3b8267e62c954d2bec8d', class: this._contentClasses, part: "content", ref: el => (this._bodyRef = el) }, index.h("wdpr-scrollbar", { key: 'c3a863f4b6279676ef45405fe7ad4017a897a35e', orientation: "vertical", size: "medium", initialPosition: 0, class: "flex-1 min-h-0", tabIndex: -1, onScrollChange: this._handleScrollChange }, index.h("slot", { key: '50e9ce8e3c5bdfdf6b219e2d5e9aa651eedac1ae', name: "body" })))), this.showFooter && (index.h("footer", { key: '666116e163a310c779cd5f54d4b9c9450ad3852e', ref: el => (this._footerRef = el), part: "footer", class: utils.customTwMerge('fixed bottom-0 z-[100000] overflow-hidden', this._sideRadiusFooterClass), style: {
                ...(this._isMobileHalfStack
                    ? {
                        width: 'var(--sheet-w)',
                        left: 'calc(var(--vvleft) + (var(--vvw) - var(--sheet-w)) / 2)',
            ...
            } }, index.h("slot", { key: '9efe5a7151eda0685f2032d1cfb1c0b6658b0ba3', name: "footer" }, index.h("wdpr-button-dock", { key: '1948813bff40a4be55bff0ff626015166cf94d2a' }, index.h("wdpr-button-bar", { key: '6715ef50f01644671b68f5aeba96aea5f2fec371', slot: "button-bar", layout: "stacked" }, index.h("wdpr-button", { key: '330413f319a6b3c07d677196262df51f87bbf061', display: "block", slot: "primary-button", variant: "primary", size: "large", onClick: this._handlePrimaryClick }, this.buttonText)))))), index.h("div", { key: '25c3bf69e21c926298d136f5e76ff8aab5619a8c', "data-focus-sentinel": "end", tabIndex: 0, "aria-hidden": "true", class: "sr-only", onFocus: () => this._handleSentinelFocus(false) })));
    }
...
exports.wdpr_drawer = WdprDrawer;
//# sourceMappingURL=wdpr-drawer.entry.cjs.js.map

//# sourceMappingURL=wdpr-drawer.cjs.entry.js.map