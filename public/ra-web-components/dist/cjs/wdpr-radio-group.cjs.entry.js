...
const WdprRadioGroup = class {
    ...
    handleKeyDown(ev) {
        ...
        const direction = (ev.key === keycodes_model.KEYBOARD_KEYS.ARROW_RIGHT || ev.key === keycodes_model.KEYBOARD_KEYS.ARROW_DOWN) ? 1
            : (ev.key === keycodes_model.KEYBOARD_KEYS.ARROW_LEFT || ev.key === keycodes_model.KEYBOARD_KEYS.ARROW_UP) ? -1
                : null;
        if (direction == null)
            return;
        ev.preventDefault();
    ...
    render() {
        return (index.h("div", { key: '10177a6138b6452ae43a34ad0c7efa843b5a45f6', role: "radiogroup", "aria-label": this.ariaLabel, class: "flex flex-col gap-2", onKeyDown: e => this.handleKeyDown(e) }, index.h("slot", { key: 'ab7e67fd6da7fb5fc545d21df37da2a34be2fd7a', onSlotchange: this._handleSlotChange })));
    }
    static get formAssociated() { return true; }
    static get watchers() { return {
        "value": ["handleValueChanged"],
        "disabled": ["handleDisabledChanged"],
        "required": ["handleRequiredChanged"]
    }; }
};

exports.wdpr_radio_group = WdprRadioGroup;
//# sourceMappingURL=wdpr-radio-group.entry.cjs.js.map

//# sourceMappingURL=wdpr-radio-group.cjs.entry.js.map