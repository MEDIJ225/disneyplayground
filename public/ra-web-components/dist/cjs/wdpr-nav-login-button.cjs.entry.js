...
const WdprNavLoginButton = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.wdprNavLoginClick = index.createEvent(this, "wdprNavLoginClick", 7);
        this.wdprNavLoginHover = index.createEvent(this, "wdprNavLoginHover", 7);
        this.wdprNavLoginFocusIn = index.createEvent(this, "wdprNavLoginFocusIn", 7);
        this.wdprNavLoginPressed = index.createEvent(this, "wdprNavLoginPressed", 7);
    }
    ...
    wdprNavLoginPressed;
    componentWillLoad() {
        this._internalId = `wdpr-nav-login-button-${utils.generateRandId()}`;
    }
    componentDidLoad() {
    ...
    get _buttonClasses() {
        return utils.customTwMerge(buttonLayoutClasses, this.loggedIn ? 'pl-050' : 'pl-125', this.loggedIn ? 'pr-100' : 'pr-150', buttonStateClasses);
    }
    get _labelSlotClasses() {
        return utils.customTwMerge(labelSlotOverlayClasses, labelBaseClasses, labelStateClasses);
    }
    get _avatarGroupClasses() {
        return utils.customTwMerge(avatarGroupBaseClasses, this.loggedIn && 'mt-050');
    }
    ...
    render() {
        return (index.h("span", { key: '5e6aca98b44d25394ed16c8a92bd177fb0bc3f3c', class: buttonWrapperClasses }, index.h("button", { key: '644e29dec5be54c419d660332ee663332e271760', id: this._internalId, class: this._buttonClasses, onClick: this._handleClick, "aria-label": this.a11yLabel || undefined, "aria-pressed": this.active ? 'true' : 'false', "data-inverse": this.inverse.toString() }, index.h("span", { key: 'e08f337205cd78fa0e1e1914ebd0f77fc00c9a1f', class: this._avatarGroupClasses }, index.h("span", { key: '398d12055d07836b0f5492075644dbe57769e80f', class: avatarClasses }, this.loggedIn ? (index.h("wdpr-avatar", { imageSrc: this.avatarSrc, altText: this.avatarAlt, size: "small", isInteractive: false })) : (index.h("wdpr-icon-library", { icon: this.iconName, size: "medium", decorative: true })))), index.h("span", { key: 'd8d1974ec8be4e8c9dcefd19dfde19c718d43ce1', class: labelAndNotificationRowClasses }, index.h("span", { key: '9b3404ad8f3ac25bbe3f714080c198f3934c6544', class: labelStrutGridClasses }, index.h("span", { key: '3f67f73af40f51fe50719306f7730a30ae7e15b1', class: labelMeasureClasses, "aria-hidden": "true" }, this._labelMeasureText), index.h("span", { key: 'fed67c64aa1c04525161a86ce0722143e55a0c49', class: this._labelSlotClasses }, index.h("slot", { key: 'f060c4ae686c9c64062a106c92ed2246be79ed40', onSlotchange: this._syncLabelMeasureText }))), this.loggedIn && (index.h("span", { key: '9f86df58d55a8304d3c3c061fa762c29e4f3d08b', class: notificationClasses }, index.h("slot", { key: '949cbe7e2fd06af13877f5f28f34cbf3ea3cc084', name: "notification" }))))), this.allowKeyboardChevron && (index.h("button", { key: '60896b0a25ea9e6f6764ece19342f18e89d26e97', type: "button", class: chevronButtonClasses, "aria-label": "Toggle menu", onKeyDown: this._handleChevronKeyDown }, index.h("wdpr-icon-library", { key: 'b34f0ab152533a467cd28c734644fda3f348f62a', icon: "next-caret-2.0", size: "xxsmall", style: { transform: this._isOpen ? 'rotate(270deg)' : 'rotate(90deg)' } })))));
    }
};
...
exports.wdpr_nav_login_button = WdprNavLoginButton;
//# sourceMappingURL=wdpr-nav-login-button.entry.cjs.js.map

//# sourceMappingURL=wdpr-nav-login-button.cjs.entry.js.map