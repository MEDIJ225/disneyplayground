...
const wdprPanelCss = ":host{display:none;position:fixed;top:0;left:0;width:100%;height:100%;z-index:99999}:host([is-open]){display:block}:host .animating{transition:transform var(--anim-ms) cubic-bezier(.22, .61, .36, 1),\n              opacity var(--anim-ms) cubic-bezier(.22, .61, .36, 1);will-change:transform, opacity}";

const WdprPanel = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.panelOpened = index.createEvent(this, "panelOpened", 7);
        this.panelClosed = index.createEvent(this, "panelClosed", 7);
        this.panelCloseRequested = index.createEvent(this, "panelCloseRequested", 7);
    ...
    _panelRef;
    _footerRef;
    _headingId = `wdpr-panel-h-${utils.generateRandId()}`;
    ...
    _onKeydown = (e) => {
        ...
        if (this._hasOpenDrawer())
            return;
        if (e.key === keycodes_model.KEYBOARD_KEYS.ESCAPE && !this.disableEscClose) {
            e.stopPropagation();
            this._closePanel();
            return;
        }
        if (e.key !== keycodes_model.KEYBOARD_KEYS.TAB)
            return;
        this._prepareFocusTrap();
    ...
    render() {
        ...
        const headerStyle = this.isBodyScrolled && !this._isFloatingButtons
            ...
            : {};
        return (index.h(index.Host, { key: '1791dcc71932ce539c0026063db733bb35736c15', style: { '--anim-ms': `${this.animationMs}ms` } }, index.h("wdpr-overlay", { key: 'dc9a9c3a6dfea748e8ed9e06d9a9db567fa2111e', cover: true, open: this.isOpen, variant: "scrim", role: "presentation", "a11y-label": "Backdrop", onOverlayClick: this._handleOverlayClick }), index.h("div", { key: 'f2093fd64c29ef60089c543e6f7a2bef71d0c0ca', style: this._panelStyle, class: this._panelLayoutClasses, part: "panel", role: "dialog", "aria-modal": "true", tabIndex: -1, "aria-label": ariaLabel, "aria-labelledby": labelledBy, ref: el => (this._panelRef = el) }, index.h("div", { key: '167a4fe84337e9254190012b3d9e2059718e49bd', "data-focus-sentinel": "start", tabIndex: this.decorative ? -1 : 0, "aria-hidden": "true", class: "sr-only", onFocus: () => this._handleSentinelFocus(true) }), index.h("header", { key: '4fcbd0bb5be84db2c4a1aeb2296ae3643493402f', class: this._headerClasses, style: headerStyle, part: "header" }, this._isFloatingButtons && (index.h("div", { key: '4b3e33234ff251e20ae708d566ccc8b6161c49ef', class: "absolute top-0 left-0 right-0 h-[100px] pointer-events-none z-10", style: {
                background: 'linear-gradient(to bottom, var(--bg-surface-default) 0%, var(--bg-surface-default) 30%, rgba(255, 255, 255, 0) 100%)',
                backdropFilter: 'blur(12px)',
                WebkitBackdropFilter: 'blur(12px)',
            } })), hasMediaBackground && (index.h("div", { key: '14c8cfa34b58ba231f9b87d35684329d36f63344', class: "absolute inset-0 z-0 overflow-hidden pointer-events-none" }, index.h("slot", { key: '5726307edab91d2943f01243b090e37db5b8360a', name: "header-background" }))), index.h("div", { key: '0e9d266dfc563c2f0b2ecbc36ea20f033256b93c', class: "relative w-full z-20" }, index.h("slot", { key: '2ad954c780066bc6c4220f53be448f5aee55f120', name: "panel-header" }, index.h("wdpr-page-header", { key: '56cbc299f586ffd0e837e57694f857dbc726274f', class: utils.customTwMerge('w-full block pt-300', this._sideRadiusHeaderClass), titleText: "", sticky: false, showElevation: false, background: "transparent", onLeadingClick: this._handleBackClick, onTrailingClick: this._handleCloseClick }, this.showBackButton && (index.h("wdpr-icon-button", { key: '862e5b66013362ed2da74b75db9cadcf322c512b', slot: "leading-icon", iconName: "back-thick", a11yLabel: "Back", size: "medium", variant: this._isFloatingButtons ? 'bgPrimary' : 'primary', onClick: this._handleBackClick })), index.h("div", { key: '660c07162cc75a1dad310111e9b88833b42d095f', slot: "trailing-icon", class: "flex gap-100" }, index.h("slot", { key: 'ef26d7787b54d91a110dc122ca5093e1f910c33b', name: "header-actions" }), this.isCloseable && (index.h("wdpr-icon-button", { key: 'af208387b84c7bd2c19c8174066dc9e9318ead8c', iconName: "close-reversed", a11yLabel: "Close", size: "medium", variant: this._isFloatingButtons ? 'bgPrimary' : 'primary', onClick: this._handleCloseClick }))), !this._isFloatingButtons && (index.h("div", { key: 'e1f32715a35758d1a535613d809102a45e33057e', slot: "below", class: "flex flex-col w-full" }, index.h("slot", { key: '67233aec5c9ad6e2347b23798685bb1ced42d98f', name: "header" }, index.h("wdpr-text-header", { key: 'd346e919f0e5fac19d5d42a5f219751e8d5b2621', id: this._headingId, class: "px-150 pb-200", headerLabel: this.titleText, subtextLabel: this.subtitleText }, this.leadingIcon && index.h("wdpr-icon-library", { key: '0ce52fa0fb9a4d8f41a52d3f3923bd3b1b3b76f7', size: "medium", icon: this.leadingIcon, slot: "leading-icon" }))), index.h("slot", { key: 'c114de80b424e41a83e96e2155d9f1041a900a0c', name: "header-content" })))))), index.h("div", { key: 'ccde81e7fa3734897b0325f259b746d27c7b7a3b', style: { display: this.showDivider && this.isBodyScrolled && !this._isFloatingButtons ? 'block' : 'none' }, "aria-hidden": !(this.showDivider && this.isBodyScrolled && !this._isFloatingButtons) ? 'true' : null }, index.h("wdpr-divider", { key: '281fcb4d657241d25eeea0ebb6819b17ef6467f0', orientation: "horizontal", class: "w-full block relative z-30" }))), index.h("div", { key: '2e6f6bc3f74050245e4b98eb7e7d9856975c57b7', class: utils.customTwMerge('flex flex-col flex-1 min-h-0 overflow-hidden', this._sideRadiusContentWrapperClass) }, index.h("section", { key: '962be42c18c34268d49f2851361caa1a110e599a', class: "min-w-0 min-h-0 flex flex-col flex-1 overflow-hidden", part: "content" }, index.h("wdpr-scrollbar", { key: 'e9321fbd705a56b3ea1385bc73d9c625c055d4f8', orientation: "vertical", size: "medium", class: "flex-1 min-h-0", onScrollChange: this._handleScrollChange }, index.h("div", { key: '330082e04f8b9eaf0149f9adaeb168caf7bc8560', style: { display: 'block', height: 'auto' } }, this._isFloatingButtons && index.h("div", { key: 'dfbab4151d0440bf30a0bf0a50dea4886fe91239', class: "h-[60px] shrink-0" }), index.h("slot", { key: 'f30d99bb6defa6885c7476d2da71e8249ad7b8c1', name: "body" })))), this.showFooter && (index.h("footer", { key: '0906fd3f847d93d23d01fafaf5f3f6c72cf1adc2', ref: el => (this._footerRef = el), part: "footer", class: utils.customTwMerge('sticky bottom-0 z-[100000] w-full', this._sideRadiusFooterClass) }, index.h("slot", { key: '10e5cd1fe700acb38650e4d651db56be67d9d735', name: "footer" }, index.h("wdpr-button-dock", { key: '4d5301a9ce1cd9c8febf46ce12f26c188875cb04' }, index.h("wdpr-button-bar", { key: '70ed1265f1f17d481bc6a6233ebf8205d2d94ef3', slot: "button-bar", layout: "stacked" }, index.h("wdpr-button", { key: '2bcd24f85fa42e150a8d27278af59b6ccdf168a6', display: "block", slot: "primary-button", variant: "primary", size: "large", onClick: this._handlePrimaryClick }, this.buttonText)))))))), index.h("div", { key: '2d9b38da4ab553102f65f1e0f6e793a49c201fe4', "data-focus-sentinel": "end", tabIndex: this.decorative ? -1 : 0, "aria-hidden": "true", class: "sr-only", onFocus: () => this._handleSentinelFocus(false) })));
    }
    static get watchers() { return {
        "isOpen": ["onOpenChanged"]
    }; }
};
WdprPanel.style = wdprPanelCss;

exports.wdpr_panel = WdprPanel;
//# sourceMappingURL=wdpr-panel.entry.cjs.js.map

//# sourceMappingURL=wdpr-panel.cjs.entry.js.map