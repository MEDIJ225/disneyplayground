...
const WdprSegmentedVerticalTab = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4c532137e820185f0768be6f3b12fe0dae4aeb90', id: this.tabId, role: "tab", "aria-selected": this.active ? 'true' : 'false', "aria-controls": this.controlsId, "aria-disabled": this.disabled ? 'true' : undefined, tabindex: this.disabled ? -1 : (this.customTabIndex ?? 0), onClick: this._handleClick, disabled: this.disabled }, index.h("div", { key: 'a78079584016aebfe9a72186e5834087b202b16b', class: "segmented-vertical-tab-icon-wrapper" }, this.icon && index.h("wdpr-icon-library", { key: '600a93e3e8ac14b03e673f1c264f4aac2581316b', icon: this.icon, size: "medium", decorative: true }), this.secondaryLabel && !this.icon && index.h("span", { key: '9d4578bccff3531d5af2aedbbf19b542c1e237a7', class: "segmented-vertical-tab-secondary-label" }, this.secondaryLabel)), index.h("span", { key: '39c54577bfc704551dd02c40e6b8881b929c1daf', class: "segmented-vertical-tab-main-label" }, this.label)));
    }
};
WdprSegmentedVerticalTab.style = wdprSegmentedVerticalTabCss;

exports.wdpr_segmented_vertical_tab = WdprSegmentedVerticalTab;
//# sourceMappingURL=wdpr-segmented-vertical-tab.entry.cjs.js.map

//# sourceMappingURL=wdpr-segmented-vertical-tab.cjs.entry.js.map