...
const WdprDoubleCalendar = class {
    constructor(hostRef) {
    ...
    _checkAndCorrectMonthView() {
        ...
        const nextMonth = date_utils.getNextMonth(this.displayDate);
        const secondMonthEnd = index$1.dateFnsExports.endOfMonth(nextMonth);
    ...
    render() {
        const nextMonth = date_utils.getNextMonth(this.displayDate);
        return (index.h(index.Host, { key: '224bd745413278d9ce525834dec17e4b22fae10f', class: { 'full-width': this.fullWidth } }, index.h("section", { key: '13b1fd9df6da3d9c4350c893a661101d7a7e9513', class: this._calendarWrapperClasses, part: "double-calendar" }, index.h("span", { key: 'c50852bd33ec1eb8887cc9fff28c24e6718da6ba', class: "hidden md:block pt-[165px]" }, index.h("wdpr-icon-button", { key: '83d9af018fc9c0a5f8d8e1f4bfbb8133fce12b16', variant: "primary", iconName: "previous", onClicked: this._onPreviousMonth, a11yLabel: "Previous Month", disabled: this._isPrevMonthDisabled })), index.h("div", { key: '8acc8402b31449236812f1c35776ff98ec1ea28d', class: this._containerClasses }, index.h("wdpr-single-calendar", { key: '0a4ef6fcfe946588d35ece05104335849fe2da9d', ...this._commonCalendarProps, displayDate: this.displayDate, monthHeaderVariant: `${this._isMobileView ? 'with-arrows' : 'default'}`, exportparts: "calendar-surface" }), index.h("wdpr-single-calendar", { key: 'b85cae9d9262c3023ec31d8d7ead8c92077fa691', class: "hidden md:block", monthHeaderVariant: "default", displayDate: nextMonth, ...this._commonCalendarProps, exportparts: "calendar-surface" })), index.h("span", { key: '338d900b241a69862eada55742f1486fe3d49646', class: "hidden md:block pt-[165px]" }, index.h("wdpr-icon-button", { key: '43a30ba45dc1a999c8ad8878953c5dbf51001b09', variant: "primary", iconName: "next", onClicked: this._onNextMonth, a11yLabel: "Next Month", disabled: this._isNextMonthDisabled })))));
    }
...
WdprDoubleCalendar.style = ":host(.full-width) { width: 100%; }";

exports.wdpr_double_calendar = WdprDoubleCalendar;
//# sourceMappingURL=wdpr-double-calendar.entry.cjs.js.map

//# sourceMappingURL=wdpr-double-calendar.cjs.entry.js.map