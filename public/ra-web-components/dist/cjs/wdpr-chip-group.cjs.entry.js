...
const WdprChipGroup = class {
    ...
    render() {
        ...
        if (this.layout === 'horizontal-scroll') {
            return (index.h("wdpr-scrollbar", { orientation: "horizontal", class: "w-full block" }, index.h("div", { part: "chip-group-container", class: this.containerClass, role: groupRole, "aria-label": ariaLabelValue }, index.h("slot", null))));
        }
        return (index.h("div", { part: "chip-group-container", class: this.containerClass, role: groupRole, "aria-label": ariaLabelValue }, index.h("slot", null)));
    }
    static get formAssociated() { return true; }
};

exports.wdpr_chip_group = WdprChipGroup;
//# sourceMappingURL=wdpr-chip-group.entry.cjs.js.map

//# sourceMappingURL=wdpr-chip-group.cjs.entry.js.map