...
var riveExports = requireRive();

const WdprRive = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.wdprLoad = index.createEvent(this, "wdprLoad", 7);
        this.wdprError = index.createEvent(this, "wdprError", 7);
        this.wdprPlay = index.createEvent(this, "wdprPlay", 7);
        this.wdprPause = index.createEvent(this, "wdprPause", 7);
        this.wdprStop = index.createEvent(this, "wdprStop", 7);
        this.wdprStateChange = index.createEvent(this, "wdprStateChange", 7);
    }
    _canvasEl;
    _riveInstance = null;
    _canvasId = `rive-canvas-${utils.generateRandId()}`;
    ...
    _getFitValue() {
        const fitMap = {
            'cover': riveExports.Fit.Cover,
            'contain': riveExports.Fit.Contain,
            'fill': riveExports.Fit.Fill,
            'fit-width': riveExports.Fit.FitWidth,
            'fit-height': riveExports.Fit.FitHeight,
            'none': riveExports.Fit.None,
            'scale-down': riveExports.Fit.ScaleDown,
        };
        return fitMap[this.fit] || riveExports.Fit.Contain;
    }
    _getAlignmentValue() {
        const alignmentMap = {
            'center': riveExports.Alignment.Center,
            'top-left': riveExports.Alignment.TopLeft,
            'top-center': riveExports.Alignment.TopCenter,
            'top-right': riveExports.Alignment.TopRight,
            'center-left': riveExports.Alignment.CenterLeft,
            'center-right': riveExports.Alignment.CenterRight,
            'bottom-left': riveExports.Alignment.BottomLeft,
            'bottom-center': riveExports.Alignment.BottomCenter,
            'bottom-right': riveExports.Alignment.BottomRight,
        };
        return alignmentMap[this.alignment] || riveExports.Alignment.Center;
    }
    _updateLayout() {
        if (this._riveInstance) {
            this._riveInstance.layout = new riveExports.Layout({
    ...
    _loadRiveAnimation() {
        ...
        this._riveInstance = new riveExports.Rive(options);
    }
    _getCanvasStyle() {
        return {
            width: this.width,
    ...
    render() {
        return (index.h("div", { key: 'f847af153765adabc33c358729dcc4d3153b890a', class: wrapperClasses, part: "wrapper", "data-loaded": this._isLoaded, "data-playing": this._isPlaying, "data-error": this._hasError }, index.h("canvas", { key: 'ad3c9829d1db0dbf3ffbbf9910d29c1e7069a52f', ref: el => (this._canvasEl = el), id: this._canvasId, class: canvasClasses, style: this._getCanvasStyle(), part: "canvas" })));
    }
    static get watchers() { return {
        "src": ["handleSrcChange"],
        "animation": ["handleAnimationChange"],
        "stateMachine": ["handleAnimationChange"],
        "fit": ["handleLayoutChange"],
        "alignment": ["handleLayoutChange"]
    }; }
};
const wrapperClasses = 'relative block overflow-hidden';
const canvasClasses = 'block';

exports.wdpr_rive = WdprRive;
//# sourceMappingURL=wdpr-rive.entry.cjs.js.map

//# sourceMappingURL=wdpr-rive.cjs.entry.js.map