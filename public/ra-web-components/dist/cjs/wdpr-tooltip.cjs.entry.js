...
const WdprTooltip = class {
    ...
    isPinned = false;
    hideTimeout = null;
    tooltipId = `tooltip-${utils.generateRandId()}`;
    HIDE_DELAY = 100;
    get isTitleEnabled() {
    ...
    handleKeyDown(event) {
        if (event.key === keycodes_model.KEYBOARD_KEYS.ESCAPE && this.isVisible) {
    ...
    getTooltipClasses() {
        ...
        return utils.customTwMerge(display, base, pointer, maxWidth);
    }
    ...
    getArrowClasses() {
        ...
        return utils.customTwMerge(base, arrowMap[this.position]);
    }
    getArrowBorderClasses() {
        ...
        return utils.customTwMerge(base, borderMap[this.position]);
    }
    render() {
        const hasContent = (this.isTitleEnabled && !!this.tooltipTitle) || (this.isDescriptionEnabled && !!this.description);
        return (index.h("div", { key: 'bc24aae7e667a051b99584692c9125153021dedd', class: "relative inline-flex" }, index.h("wdpr-info-icon-with-tooltip", { key: '7c39a70523906ff5d0a34f89d078e74b56e6dd11', icon: this.icon, selected: this.isVisible, showTitle: this.isTitleEnabled, showDescription: this.isDescriptionEnabled, a11yLabel: this.tooltipAriaLabel, tooltipId: this.isVisible ? this.tooltipId : undefined, label: this.label, onInfoIconClick: this.handleIconClick, onInfoIconHover: this.handleIconHover, onInfoIconLeave: this.handleIconLeave }), this.isVisible && (index.h("div", { key: 'c762f05ceaf83352e55c85ff8f9587d6df45ce68', id: this.tooltipId, role: "tooltip", class: utils.customTwMerge(this.getTooltipClasses(), this.getTooltipPositionClasses()), onMouseEnter: this.handleTooltipEnter, onMouseLeave: this.handleTooltipLeave }, index.h("div", { key: '8f19584ab32b33a6df89024b28e9489a04c7bbeb', class: this.getTooltipInnerClasses() }, this.isTitleEnabled && this.tooltipTitle && (index.h("div", { key: '73b077647f4a128275ba76503a02180e29276eee', class: "body-small-alt text-text-heading" }, this.tooltipTitle)), this.isDescriptionEnabled && this.description && (index.h("div", { key: 'b47beee95e1f640df17a7709f1c6957f41a8eef7', class: "body-small text-text-body" }, this.description)), index.h("div", { key: '36378af1a19fce8b29148cd7c977697d21e73559', class: hasContent ? 'mt-050' : '' }, index.h("slot", { key: '20bbbfc8425d9b96191b5c9492bd9a562a3f9370' })), index.h("div", { key: '696025e854cb29e2e468ab2f61f837bc0909ecb7', class: this.getArrowBorderClasses() }), index.h("div", { key: '5f0d7a1958ebbb82f3f7833321b4c69d86de0ff4', class: this.getArrowClasses() }))))));
    }
};

exports.wdpr_tooltip = WdprTooltip;
//# sourceMappingURL=wdpr-tooltip.entry.cjs.js.map

//# sourceMappingURL=wdpr-tooltip.cjs.entry.js.map