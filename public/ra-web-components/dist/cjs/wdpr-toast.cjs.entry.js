...
const WdprToast = class {
    constructor(hostRef) {
        ...
        this.toastDismissed = index.createEvent(this, "toastDismissed", 7);
    }
    _enterRef = null;
    ...
    /** Icons */
    _getIcon() {
        return index.h("wdpr-status-icon", { variant: this.toastStyle, size: "xxsmall", ariaLabel: this._getAccessibleLabel(this.toastStyle) });
    }
    _getButtonVariant() {
    ...
    _getAction() {
        if (this.actionType === 'close') {
            return (index.h("wdpr-icon-button", { variant: this.toastStyle === 'error' ? 'tertiary-alt' : 'primary', iconName: "close-reversed", a11yLabel: this.closeAriaLabel, size: "xxsmall", class: this._getActionClasses(), onClick: this.handleAction }));
        }
        return (index.h("slot", { name: "action" }, index.h("wdpr-button", { variant: this._getButtonVariant(), onClick: this.handleAction, a11yLabel: this.actionAriaLabel || this.actionText, display: "block", size: "small" }, this.actionText)));
    }
    ...
    render() {
        ...
        const forwarded = { ...(utils.forwardCommonHostAttributes(this.el) || {}) };
        if ('role' in forwarded)
            delete forwarded.role;
        return (index.h(index.Host, { key: '085b5b08d40431de3d188ab89a07599efb6c70b9', class: this._getHostClass() }, index.h("wdpr-surface-style", { key: 'd596b74c511c355caeaed7e23b24b61f7d88cbe0', ...forwarded, ...this._getValidatedRoleAttr(), variant: this._getSurfaceVariant(), padding: "md", class: this._getContainerClasses() }, index.h("div", { key: '8c249255cc57e4f5ce321db6ca16f4d629dd154e', class: this._getContentClasses() }, index.h("div", { key: '1cc526281cb086a7a0fa60ba2a0840d97a0a1e2d', class: "shrink-0" }, this._getIcon()), index.h("div", { key: 'cfc5b6e9f5b9a422744441f9534d11d30d25eaf2', class: "flex-1 items-start flex flex-col gap-050 min-w-0 pt-025" }, index.h("h2", { key: '20b3b47e4ab7ae25b9835f7aa2ec2e2968679c86', part: "title", class: this._getTitleClasses(), title: this.toastTitle || undefined }, this.toastTitle), this.showDescription && (index.h("p", { key: '2655c27b23cd881aa143f4fe79d948c5952544c7', part: "description", class: this._getDescriptionClasses(), title: this.description || undefined }, this.description))), index.h("div", { key: '6cb7bcd766ec8530d2214fc63243c3a8143cf069', class: this._getActionContainerClasses() }, this._getAction())))));
    }
...
exports.wdpr_toast = WdprToast;
//# sourceMappingURL=wdpr-toast.entry.cjs.js.map

//# sourceMappingURL=wdpr-toast.cjs.entry.js.map