...
const WdprIndicatorDots = class {
    ...
    dotClass(index) {
        ...
        return utils.customTwMerge('rounded-pill transition-all duration-200 ease-enchanted-ease', size, color);
    }
    render() {
        return (index.h("div", { key: '4d88c27e11051873b302bb3feafae33c574592de', part: "container", role: "tablist", "aria-label": this.a11yLabel, class: "inline-flex items-center gap-050 md:gap-075 px-100 py-075 md:px-150 md:py-125 rounded-pill bg-effect-plum-900-a78" }, this.visibleIndices.map(i => (index.h("span", { key: i, part: i === this.activeIndex ? 'dot dot-active' : 'dot', role: "tab", "aria-selected": String(i === this.activeIndex), "aria-label": `Slide ${i + 1} of ${this.count}`, class: this.dotClass(i) })))));
    }
};

exports.wdpr_indicator_dots = WdprIndicatorDots;
//# sourceMappingURL=wdpr-indicator-dots.entry.cjs.js.map

//# sourceMappingURL=wdpr-indicator-dots.cjs.entry.js.map