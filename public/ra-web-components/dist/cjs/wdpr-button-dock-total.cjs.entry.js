...
const WdprButtonDockTotal = class {
    ...
    get containerClass() {
        ...
        return utils.customTwMerge('w-full flex items-center', justify);
    }
    /** Main integer (and sign/group) class */
    get integerClass() {
        const sizeClass = this.size === 'lg' ? 'title-large' : this.size === 'md' ? 'title-medium' : 'title-small';
        return utils.customTwMerge(sizeClass, 'tracking--05 text-text-body');
    }
    ...
    get decimalClass() {
        ...
        return utils.customTwMerge(sizeClass, 'tracking--05 self-stretch pt-025 text-text-body');
    }
    ...
    render() {
        const v = this.amount;
        return (index.h("div", { key: 'aaa8c2dea3558e61f29f0f7cd4b9d3a4350156bd', class: this.containerClass, "aria-live": "polite" }, typeof v === 'number' ? ((() => {
            ...
            if (symbolBefore) {
                return (index.h("span", { class: "inline-flex items-baseline" }, index.h("span", { class: this.symbolClass }, symbol), gapAfterSymbol ? index.h("span", { "aria-hidden": "true" }, gapAfterSymbol) : null, index.h("span", { class: this.integerClass }, integer), decimal ? index.h("span", { class: this.decimalClass }, decimal) : null));
            }
            // symbol after the number
            return (index.h("span", { class: "inline-flex items-baseline" }, index.h("span", { class: this.integerClass }, integer), decimal ? index.h("span", { class: this.decimalClass }, decimal) : null, gapBeforeSymbol ? index.h("span", { "aria-hidden": "true" }, gapBeforeSymbol) : null, index.h("span", { class: this.symbolClass }, symbol)));
        })()) : (
        // String fallback (verbatim, not split)
        index.h("span", { class: this.integerClass }, v ?? '—'))));
    }
};

exports.wdpr_button_dock_total = WdprButtonDockTotal;
//# sourceMappingURL=wdpr-button-dock-total.entry.cjs.js.map

//# sourceMappingURL=wdpr-button-dock-total.cjs.entry.js.map