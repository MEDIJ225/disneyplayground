...
const WdprTextField = class {
    ...
    componentWillLoad() {
        this._internalId = this.inputId || `wdpr-text-field-${utils.generateRandId()}`;
        this._updateButtonsDisabledState();
    }
    componentDidLoad() {
    ...
    render() {
        return (index.h(index.Host, { key: '7846e2f6b06fccebe38ee7fea18b756c8ea42ec6' }, index.h("div", { key: 'fe9a1a313018d05742b305cc630b24f717c83c3b', class: "text-field-wrapper" }, this._leadingIcon && (index.h("span", { key: 'ee6c2a45220882c0176fa604389137721a0ed3d5', onClick: this._onLeadingClick, part: "leading-icon-button-wrapper", class: "icon-wrapper" }, index.h("slot", { key: '3fa65cc5b39802e0f2776e083c24384a456e164a', onSlotchange: this._handleSlotChange, name: "leading-icon-button" }))), index.h("div", { key: 'c7bb27cec6832e8b8015178f2fa937785c5c6fbe', class: "input-wrapper", part: "input-wrapper" }, index.h("input", { key: 'aa395e79c3cbb6246dc92d690558443abaeba1ff', ref: el => (this._nativeInput = el), type: this.type, placeholder: " ", id: this._internalId, class: "input", disabled: this.disabled, name: this.name, maxlength: this.maxLength, value: this._getDisplayValue(this.value), tabindex: this.disabled ? -1 : this.customTabindex, autocomplete: this.autocomplete ? this.autocomplete : undefined, readonly: this.readonly, role: this.a11yRole, "aria-disabled": this.a11yDisabled ?? this.disabled.toString(), "aria-invalid": this.error.toString(), "aria-describedby": this.a11yDescribedBy || (this.helperText ? `${this._internalId}-helper-text` : undefined), "aria-haspopup": this.a11yHasPopup, "aria-controls": this.a11yControls, "aria-expanded": this.a11yExpanded, "aria-autocomplete": this.a11yAutoComplete, "aria-activedescendant": this.a11yActiveDescendant, "aria-required": this.a11yRequired, onInput: this._handleInput, onFocus: this._handleFocus, onBlur: this._handleBlur, onClick: this._handleClick }), index.h("label", { key: '78ef3792f343a5acfe8f9ea4831cf2ad9d5761aa', htmlFor: this._internalId, class: "input-label" }, this.label, " ", this._requirementLabel)), this._trailingIcon && (index.h("span", { key: '87973c83c1c5869c45ff8cb4ffe5b75df517bbf6', onClick: this._onTrailingClick, part: "trailing-icon-button-wrapper", class: "icon-wrapper" }, index.h("slot", { key: '1a13cf03524e589f2bfbe333b93710d302e9569e', onSlotchange: this._handleSlotChange, name: "trailing-icon-button" })))), this.helperText && (index.h("div", { key: '60f74ad65d9f2f91bf28c3ac0a30206d3d92eda3', class: "inline-message-wrapper", part: "helper-text-wrapper" }, index.h("wdpr-inline-message", { key: '2badb88c52f70579f647219bdccb082744c1d281', id: `${this._internalId}-helper-text`, variant: this.error ? 'error' : 'informational', size: "small", role: "status" }, this.helperText)))));
    }
...
exports.wdpr_text_field = WdprTextField;
//# sourceMappingURL=wdpr-text-field.entry.cjs.js.map

//# sourceMappingURL=wdpr-text-field.cjs.entry.js.map