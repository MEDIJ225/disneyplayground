...
const WdprIcon = class {
    ...
    getContainerClasses() {
        ...
        return utils.customTwMerge(baseClasses, sizeClasses, variantClasses.bg, variantClasses.color, backgroundShape, squareRadius, this.customClass || '');
    }
    render() {
        return (index.h("wdpr-surface-style", { key: 'cc41d6b1ad935840a0634d08520e07cdd6c5de8b', variant: "none", padding: "none" }, index.h("div", { key: '0e86ab750f3514ca7c52ee38034ee2c9958b6318', class: this.getContainerClasses() }, index.h("wdpr-icon-library", { key: 'cc489640b7512fffbe103872b518d3c93ceb4ac1', icon: this.icon, size: this.size, ariaTitle: this.iconTitle, ariaDescription: this.iconDescription, a11yLabel: this.a11yLabel, decorative: this.decorative }), this.iconDescription && index.h("span", { key: '2e66982f02c34d935a41c767d6c91787692cc6f4', class: "sr-only" }, this.iconDescription))));
    }
};
WdprIcon.style = ":host {\n      display: flex;\n      align-items: center;\n      justify-content: center;\n    }";

exports.wdpr_icon = WdprIcon;
//# sourceMappingURL=wdpr-icon.entry.cjs.js.map

//# sourceMappingURL=wdpr-icon.cjs.entry.js.map