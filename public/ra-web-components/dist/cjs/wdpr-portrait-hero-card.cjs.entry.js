...
const WdprPortraitHeroCard = class {
    ...
    a11yAlt;
    get _contentClasses() {
        return utils.customTwMerge(contentBaseClasses, gradientClassMap[this.gradient]);
    }
    render() {
        return (index.h("article", { key: 'ff2134710cdf674d9fe75dd3815eb0cd7f313e94', class: baseClasses }, index.h("figure", { key: '9c8e961d65e8d953de45c682b1c72ab686d07809', class: mediaWrapperClasses }, index.h("wdpr-media", { key: 'c749b39e0d05601232054f80593cd1944994144d', src: this.src, alt: this.a11yAlt, aspect: "portrait", objectFit: "cover", portraitRatio: "2:3" }), index.h("div", { key: 'de232f3ee33d3c68a2892a916e9ad85f635ca4c8', class: this._contentClasses }, index.h("span", { key: '05b186abc9642298da9a31e4fcdc66221cca0d2a', class: headlineClasses }, this.headline), index.h("p", { key: '19f09edbaaab0acf6208c1018fb2a97d50efe3de', class: bodyClasses }, this.body)))));
    }
};
...
exports.wdpr_portrait_hero_card = WdprPortraitHeroCard;
//# sourceMappingURL=wdpr-portrait-hero-card.entry.cjs.js.map

//# sourceMappingURL=wdpr-portrait-hero-card.cjs.entry.js.map