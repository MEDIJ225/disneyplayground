...
const WdprStandaloneResultsList = class {
    ...
    _renderContent() {
        ...
        return (index.h(TagType, { class: "wrapper flex flex-col gap-y-100 p-200" }, index.h("slot", { onSlotchange: this._handleSlotChange })));
    }
    get _wrapperClasses() {
        return utils.customTwMerge('overflow-y-auto', this._readyToShow ? 'visible' : 'invisible');
    }
    render() {
        const needsScrollbar = this._measuredMaxHeight !== null;
        return (index.h("div", { key: '9ec00f42f2239507ce0f3591922cdd1f9e07b2db', class: this._wrapperClasses, style: { height: this._measuredMaxHeight } }, !this.isLoading && !this.errorOnLoad && !this.isEmpty && (index.h(index.Fragment, { key: '7b42b28c6327e7bc993998fb70decce4ec3b3107' }, needsScrollbar ? (index.h("wdpr-scrollbar", { orientation: "vertical", size: "small" }, this._renderContent())) : (this._renderContent()))), this.isLoading && this.loadingText && (index.h("wdpr-surface-style", { key: '2a175f961613a4064018d903c84fbd620e36d43f', variant: "basic", customClass: "elevation-xsmall-soft py-300 px-200 flex flex-col items-center justify-center" }, index.h("wdpr-radial-loader", { key: 'd9b087d3cc624d0ca8b3803736876b9e966586b6', label: this.loadingText, size: this.loaderSize, labelPlacement: this.loaderLabelPlacement, showLabel: this.showLoaderLabel }))), !this.isLoading && this.isEmpty && this.emptyText && (index.h("wdpr-surface-style", { key: '6274a07bdf76900d2cc9adbd3f021dafe420be6f', variant: "basic", customClass: "elevation-xsmall-soft py-600 px-200" }, index.h("div", { key: '17b0fa9b59f70279d500ea6a841615a914723dca', class: "flex flex-col items-center justify-center gap-100 text-text-disabled" }, index.h("wdpr-icon-library", { key: '99afb29036007a312ffe25bb4a5f569235cafbc6', icon: this.emptyIcon, size: this.emptyIconSize, decorative: true }), index.h("p", { key: 'ee6d0c0366efdfbccdaa9df73a15f9a6a9ccfc9a', class: "text-body-large text-text-disclaimer" }, this.emptyText)))), !this.isLoading && this.errorOnLoad && this.errorText && (index.h("wdpr-surface-style", { key: '530272a739f9309e540541949062000a91a9bc18', variant: "basic", customClass: "elevation-xsmall-soft py-600 px-200 flex flex-col items-center justify-center" }, index.h("wdpr-inline-message", { key: '5e57cc41a5e8f79bcaaf2c1969034f40e4f37585', variant: "error", size: this.errorTextSize }, this.errorText)))));
    }
...
exports.wdpr_standalone_results_list = WdprStandaloneResultsList;
//# sourceMappingURL=wdpr-standalone-results-list.entry.cjs.js.map

//# sourceMappingURL=wdpr-standalone-results-list.cjs.entry.js.map