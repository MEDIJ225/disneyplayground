...
const WdprModal = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.closedOnBackgroundClick = index.createEvent(this, "closedOnBackgroundClick", 7);
        this.openChangedEvent = index.createEvent(this, "open-changed", 7);
        this.closedOnEscape = index.createEvent(this, "closedOnEscape", 7);
    }
    _dialogEl;
    _focusableElements = [];
    ...
    _isMobileViewport = typeof window !== 'undefined' ? breakpoint_utils.isMobile() : false;
    ...
    _handleKeyDown = (e) => {
        ...
        if (e.key === keycodes_model.KEYBOARD_KEYS.ESCAPE || e.key === keycodes_model.KEYBOARD_KEYS.ESC) {
    ...
    _getDialogClasses() {
        ...
        if (isMobileFullscreen) {
            return utils.customTwMerge(dialogBaseClasses, dialogFullscreenClasses);
        }
        if (this.width) {
            return utils.customTwMerge(dialogBaseClasses, dialogBaseWidthClasses);
        }
        return utils.customTwMerge(dialogBaseClasses, dialogResponsiveWidthClasses);
    }
    _getContentClasses() {
        const isMobileFullscreen = this.fullscreen && this._isMobileViewport;
        if (isMobileFullscreen) {
            return utils.customTwMerge(dialogContentBaseClasses, dialogContentFullscreenClasses);
        }
        if (this.height) {
            return utils.customTwMerge(dialogContentBaseClasses, dialogContentCustomHeightClasses);
        }
        return utils.customTwMerge(dialogContentBaseClasses, dialogContentDefaultClasses);
    }
    _getDialogStyles() {
        return {
    ...
    _getDialogFrameClasses() {
        const isMobileFullscreen = this.fullscreen && this._isMobileViewport;
        if (isMobileFullscreen) {
            return utils.customTwMerge(dialogFrameClasses, 'rounded-none');
        }
        return utils.customTwMerge(dialogFrameClasses, 'rounded-200');
    }
    render() {
        ...
        return (index.h("dialog", { key: '28a9bb2be84dae2c34b865f8105a8947764dde46', "aria-label": this.ariaLabel, class: dialogClasses, style: dialogStyles, ref: el => (this._dialogEl = el), onClick: this._closeOnBackground, onMouseDown: this.isDraggable ? this._startDrag : undefined, onKeyDown: this._handleKeyDown, onCancel: this._handleCancel }, index.h("div", { key: 'afe6e6fece5d4bbab823c69d8284e053e9b4e5a7', class: dialogOverlayLayerClasses }, index.h("slot", { key: '22c7b62f0c92c272a1f27c0fea4a7170dc0f5cee', name: "overlay" })), index.h("div", { key: '8522a6cc70a5e6b1fe46385168f90a601d811b70', class: frameClasses }, index.h("div", { key: 'e3364c2dea488ec95d9c46d9ab93c5e140d1f65f', class: contentClasses, style: contentStyles }, index.h("slot", { key: '0d58864acf644542814d37ba500e3bf0cbe70325' })))));
    }
...
WdprModal.style = wdprModalCss;

exports.wdpr_modal = WdprModal;
//# sourceMappingURL=wdpr-modal.entry.cjs.js.map

//# sourceMappingURL=wdpr-modal.cjs.entry.js.map