...
const WdprCarousel = class {
    ...
    render() {
        return (index.h("section", { key: '3571d55f777d28b7ab4626faabe309b2898a3e22', class: "relative" }, this._showPrevButton && (index.h("wdpr-icon-button", { key: '8195403608a54b1d16c6ad0329edce2f67bcac60', class: "absolute left-0 top-1/2 translate-x-0 -translate-y-1/2 z-10 hidden lg:block", iconName: "previous", variant: "bgPrimary", a11yLabel: "Previous Card", onClicked: this._handlePrev })), index.h("div", { key: '58cb4483e164aa4b6ff2a354fc6e9755f1c66529', class: "overflow-x-visible lg:overflow-x-scroll no-scrollbar py-300 lg:pointer-events-none", ref: el => (this._scrollContainer = el) }, index.h("div", { key: '3b6b9c6a47f14b90ce3e4983a02cdbc7b14b3f9c', class: "scroll-items-container grid grid-flow-col" }, index.h("slot", { key: 'ee93b6cda972c4834324605244e1fa74eece372e', onSlotchange: this._handleSlotChange }))), this._showNextButton && (index.h("wdpr-icon-button", { key: '2fdfae5164a05afd84c5f5ae0f438f688f1e899a', class: "absolute right-0 top-1/2 translate-x-0 -translate-y-1/2 z-10 hidden lg:block", iconName: "next", variant: "bgPrimary", a11yLabel: "Next Card", onClicked: this._handleNext }))));
    }
};
WdprCarousel.style = wdprCarouselCss;

exports.wdpr_carousel = WdprCarousel;
//# sourceMappingURL=wdpr-carousel.entry.cjs.js.map

//# sourceMappingURL=wdpr-carousel.cjs.entry.js.map