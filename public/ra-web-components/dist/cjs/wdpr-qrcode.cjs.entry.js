...
var QRCode = /*@__PURE__*/_commonjsHelpers.getDefaultExportFromCjs(browserExports);

const WdprQrcode = class {
    constructor(hostRef) {
    ...
    render() {
        return (index.h("div", { key: 'f88861a3dd6730b3075162958b84152d0aa0d5cd', class: "inline-flex items-center justify-center", ref: (el) => (this._qrCodeContainer = el), "aria-label": this.a11yLabel ?? `QR code for: ${this.text ?? ''}`, role: "img" }));
    }
    static get watchers() { return {
        "text": ["handlePropsChange"],
        "size": ["handlePropsChange"],
        "correctionLevel": ["handlePropsChange"]
    }; }
};
WdprQrcode.style = ":host { display: inline-block; }";

exports.wdpr_qrcode = WdprQrcode;
//# sourceMappingURL=wdpr-qrcode.entry.cjs.js.map

//# sourceMappingURL=wdpr-qrcode.cjs.entry.js.map