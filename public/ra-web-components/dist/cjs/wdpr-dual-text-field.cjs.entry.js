...
const WdprDualTextField = class {
    constructor(hostRef) {
        ...
        this.wdprTrailingIconClick = index.createEvent(this, "wdprTrailingIconClick", 7);
    ...
    componentWillLoad() {
        this._internalLeadingInputId = this.leadingInputId || `wdpr-dual-text-input-${utils.generateRandId()}`;
        this._internalTrailingInputId = this.trailingInputId || `wdpr-dual-text-input-${utils.generateRandId()}`;
    ...
    render() {
        return (index.h(index.Host, { key: '86977538dabd0a026697c976f0ef506a07a89cdc', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("div", { key: '03c506c70956ba94974336a3a3d48456621b2e94', class: "dual-text-field-wrapper" }, this._leadingIconButton && (index.h("span", { key: 'ad6a19af8ee5f72b8a8c3ea13b7ef43a087a1078', onClick: this._onLeadingClick, part: "leading-icon-button-wrapper" }, index.h("slot", { key: '529066a749d023e1bc5b5838abcda75f795c0ced', name: "leading-icon-button", onSlotchange: this._handleSlotChange }))), index.h("div", { key: '3d5d3651ce5bb1a0ded04e4ccbb3545f5e877193', class: "input-wrapper", part: "input-wrapper" }, index.h("input", { key: '5c515de5da8c6ae1ef23dbd2db95f3131d469db3', ref: el => (this._leadingInputEl = el), type: "text", id: this._internalLeadingInputId, placeholder: " ", class: "input", disabled: this.disabled, value: this.readonly && !this.leadingValue ? '--' : this.leadingValue, readonly: this.readonly, role: this.a11yRole, "aria-haspopup": this.a11yHasPopup, "aria-controls": this.a11yControls, "aria-expanded": this.a11yExpanded, "aria-autocomplete": this.a11yAutoComplete, "aria-activedescendant": this._leadingFocused ? this.a11yActiveDescendant : undefined, "aria-required": this.a11yRequired, "aria-invalid": this.error.toString(), onFocus: this._handleLeadingFocus, onInput: this._handleLeadingInput, onClick: this._handleLeadingInputClick, onBlur: this._handleLeadingBlur, part: "input" }), index.h("label", { key: '448f7434ba4da8931cf30afc15c8c0fa2210c895', htmlFor: this._internalLeadingInputId, class: "input-label" }, this.leadingLabel, this._requirementLabel(this.leadingRequirementIndicator))), index.h("div", { key: '61c8aabafce7305568eb9304df41d1570b6ed6b3', class: "divider-wrapper" }, index.h("wdpr-divider", { key: '94a08c0fdde6d902e202b41faf89faae631f2e6b', orientation: "vertical" })), index.h("div", { key: '0aaa94fc406a1894aaa3168bf90ab6d242866b7e', class: "input-wrapper", part: "input-wrapper" }, index.h("input", { key: '575c5061596a57a8ba2a13bc60fdba14575b916d', ref: el => (this._trailingInputlEl = el), type: "text", id: this._internalTrailingInputId, placeholder: " ", class: "input", value: this.readonly && !this.trailingValue ? '--' : this.trailingValue, disabled: this.disabled, readonly: this.readonly, role: this.a11yRole, "aria-haspopup": this.a11yHasPopup, "aria-controls": this.a11yControls, "aria-expanded": this.a11yExpanded, "aria-autocomplete": this.a11yAutoComplete, "aria-activedescendant": this._trailingFocused ? this.a11yActiveDescendant : undefined, "aria-required": this.a11yRequired, "aria-invalid": this.error.toString(), onFocus: this._handleTrailingFocus, onInput: this._handleTrailingInput, onClick: this._handleTrailingInputClick, onBlur: this._handleTrailingBlur, part: "input" }), index.h("label", { key: '4302d85f885f14214a0d7c16691d51394f17f33f', htmlFor: this._internalTrailingInputId, class: "input-label" }, this.trailingLabel, this._requirementLabel(this.trailingRequirementIndicator))), this._trailingIconButton && (index.h("span", { key: 'ad1f12d2048e8d0f3d0eaa43ecd079e05dab9b63', onClick: this._handleTrailingClick, part: "trailing-icon-button-wrapper" }, index.h("slot", { key: '09dc91d72724cf280219f8bf8e612261688c308e', name: "trailing-icon-button", onSlotchange: this._handleSlotChange })))), this.helperText && (index.h("div", { key: '70b93d7dcbcc26fa64d6b4451f79ea88c38a047f', class: "inline-message-wrapper", part: "helper-text-wrapper" }, index.h("wdpr-inline-message", { key: '922f6b22db2218b7c34b48dd89892de8662eaa30', variant: this.error ? 'error' : 'informational', size: "small", role: "status" }, this.helperText)))));
    }
...
exports.wdpr_dual_text_field = WdprDualTextField;
//# sourceMappingURL=wdpr-dual-text-field.entry.cjs.js.map

//# sourceMappingURL=wdpr-dual-text-field.cjs.entry.js.map