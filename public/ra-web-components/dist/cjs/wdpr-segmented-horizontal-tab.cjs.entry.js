...
const WdprSegmentedHorizontalTab = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4691d7ebcf603d739ba63e87461826d80cbe581e', id: this.tabId, role: "tab", tabindex: this.disabled ? -1 : (this.customTabIndex ?? 0), "aria-selected": this.active ? 'true' : 'false', "aria-controls": this.controlsId, "aria-disabled": this.disabled ? 'true' : undefined, "aria-label": this.a11yLabel, onClick: this._handleClick }, this.icon && index.h("wdpr-icon-library", { key: '164e27312920f51452b736ebad23f917f4a46073', icon: this.icon, size: "medium", decorative: true }), this.label && index.h("span", { key: 'b3aac18dbaaec0e31e7c5d0d170d88f47215f41f', class: "segmented-horizontal-tab-main-label" }, this.label)));
    }
};
WdprSegmentedHorizontalTab.style = wdprSegmentedHorizontalTabCss;

exports.wdpr_segmented_horizontal_tab = WdprSegmentedHorizontalTab;
//# sourceMappingURL=wdpr-segmented-horizontal-tab.entry.cjs.js.map

//# sourceMappingURL=wdpr-segmented-horizontal-tab.cjs.entry.js.map