...
const WdprSurfaceStyle = class {
    ...
    _getActionableStateClasses() {
        ...
        if (this.disabled) {
            if (stateConfig.disabled) {
                ...
                cssClasses = utils.customTwMerge(cssClasses, 'bg-surface-actionable-card-disabled border-stroke-disabled cursor-not-allowed');
            }
        }
        else {
            cssClasses = utils.customTwMerge(cssClasses, stateConfig.default, stateConfig.hover, stateConfig.active);
        }
        return cssClasses;
    }
    ...
    _getSurfaceClasses() {
        ...
        return utils.customTwMerge(baseClasses, paddingClasses, variantClass, stateClasses, this.customClass);
    }
    _getSemanticRole() {
        if (this.role)
            return this.role;
    ...
    _getOverlayActionClasses() {
        return utils.customTwMerge('absolute inset-0 w-full h-full z-[1]', 'bg-transparent border-none m-0 p-0', 'cursor-pointer appearance-none', 'focus:outline-none', 'rounded-[inherit]', 'focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-solid focus-visible:outline-focus focus-visible:outline-stroke-actionable-focused');
    }
    render() {
        const role = this._getSemanticRole();
        const isActionable = this._isActionableVariant();
        return (index.h("div", { key: '0ac0b257b6deec23abe9240f4bc6f18ac22ceca2', class: utils.customTwMerge(this._getSurfaceClasses(), 'relative'), role: role, part: "surface" }, index.h("slot", { key: 'e5afa413d4aa1c54ae7bb06b96fda414c11ed99f' }), isActionable && (index.h("button", { key: 'b33e8a7b82e0a31c2cac62841938762e740b81f6', type: "button", disabled: this.disabled, "aria-pressed": this.selected ? 'true' : 'false', "aria-label": this.a11yLabel, class: this._getOverlayActionClasses() }))));
    }
};

exports.wdpr_surface_style = WdprSurfaceStyle;
//# sourceMappingURL=wdpr-surface-style.entry.cjs.js.map

//# sourceMappingURL=wdpr-surface-style.cjs.entry.js.map