...
const WdprSearchInput = class {
    constructor(hostRef) {
        ...
        if (hostRef.$hostElement$["s-ei"]) {
            ...
            this._internals = hostRef.$hostElement$.attachInternals();
            hostRef.$hostElement$["s-ei"] = this._internals;
        }
    }
    ...
    get _textFieldClass() {
        ...
        const statusClasses = bundleCjs.bundleCjsExports.twMerge(baseClass, marginClass, variantClasses.default, variantClasses.hover, variantClasses.focus);
        const disabledClasses = bundleCjs.bundleCjsExports.twMerge(baseClass, marginClass, disabledClass);
    ...
    get _labelClass() {
        ...
        return bundleCjs.bundleCjsExports.twMerge('search-input-label', leftClass, rightClass);
    }
    componentWillLoad() {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '1e2c8ebf500b6f0977e186ba2dd57a77859347dc', class: { 'search-input--empty': !(this.value ?? '').length } }, index.h("div", { key: 'ea31ce0621e49c4ff099014d14b32a4bc5fb2e89', class: "flex items-center relative w-full" }, index.h("input", { key: 'c7a9a755a5b31f9966cc40936522397499961d23', ref: el => (this._nativeInput = el), type: "search", placeholder: " ", id: this._internalId, class: this._textFieldClass, disabled: this.disabled, "aria-disabled": this.disabled ? 'true' : 'false', "aria-label": this.label, name: this.name, value: this.value, onInput: this._handleInput, tabIndex: this.disabled ? -1 : this.customTabindex, onFocus: this._handleFocus, onBlur: this._handleBlur, onClick: this._handleClick }), index.h("label", { key: '9aaf70c2d2fd80176f8f4984e640a0b81d201fbc', htmlFor: this._internalId, class: this._labelClass }, this.label), this.showLeadingIcon && (index.h("span", { key: 'e5be4bb1cfdbb445d6738ead63152b95f97741e1', class: `${leadingIconClass} ${hasValue ? 'cursor-pointer' : 'cursor-default'}`, onClick: hasValue ? this._onLeadingClick : undefined }, hasValue ? (index.h("slot", { name: "back-icon" }, index.h("wdpr-icon-button", { variant: "primary", iconName: "back-thick", a11yLabel: "back", size: "small", disabled: this.disabled }))) : (index.h("slot", { name: "search-icon" }, index.h("wdpr-icon-library", { icon: "search", size: "small", a11yLabel: "Search" }))))), this.value && (index.h("span", { key: 'd973adb0a06e1456d513daa4921c2c77c24a48d5', class: trailingIconClass, onClick: this._onTrailingClick }, index.h("slot", { key: 'b25c773355661dec31f34a8b90600f8e91b4e56e', name: "trailing-icon" }, index.h("wdpr-search-input-clear-button", { key: '4c23e886a7ed3aed1d2109ea374c3f7334cf7e03', a11yLabel: "Clear search", disabled: this.disabled })))))));
    }
...
WdprSearchInput.style = wdprSearchInputCss;

exports.wdpr_search_input = WdprSearchInput;
//# sourceMappingURL=wdpr-search-input.entry.cjs.js.map

//# sourceMappingURL=wdpr-search-input.cjs.entry.js.map