...
const getContainerClass = (disabled, selected, isInverse) => {
    ...
    if (disabled || !selected) {
        return utils.customTwMerge(containerBaseClass, inverseOutline);
    }
    if (isInverse) {
        return utils.customTwMerge(containerBaseClass, inverseSelectedSurfaceClass, inverseOutline);
    }
    return utils.customTwMerge(containerBaseClass, selectedSurfaceClass, inverseOutline);
};
...
const WdprNavItemSelectable = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.wdprSelectChange = index.createEvent(this, "wdprSelectChange", 7);
    }
    ...
    componentWillLoad() {
        this._updateSlots();
        this._internalId = this.componentId || `wdpr-nav-item-selectable-${utils.generateRandId()}`;
    }
    componentDidLoad() {
        this._updateClampState();
    ...
    render() {
        return (index.h("div", { key: '3e3f9c9d6ea419db39b66df123de8dd70417321d', tabIndex: this.disabled ? -1 : 0, class: this._containerClass, id: this._internalId, role: "button", "aria-disabled": this.disabled ? 'true' : undefined, "aria-pressed": this._isSelected ? 'true' : 'false', "aria-label": this._accessibleLabel, onClick: this._onItemInteraction, onKeyDown: this._onItemKeyDown }, index.h("section", { key: 'a588d42f29ae406ec97027b5fb23d368c142c6ba', class: `flex min-w-0 flex-1 gap-100 ${this._contentAlignmentClass}` }, this._leadingSlot && (index.h("div", { key: '160cf423dcf05893f7477a26d8113f4c7b4f2818', class: `flex shrink-0 ${this._contentAlignmentClass} ${this._paddingClass} ${this._colorClass}` }, index.h("slot", { key: '9e66da0503594597876d402fd5a955e12969e321', name: "leading-icon", onSlotchange: this._updateSlots }))), index.h("span", { key: 'e53a6da17cf545e79e79201c411332b4d4f8c9fb', class: this._labelClass, ref: el => (this._labelElement = el) }, this.label)), index.h("section", { key: 'b0493cfb472cba9553b849a6f7a2bdad47cc7f1e', class: `flex shrink-0 ${this._trailingSectionAlignmentClass} ${this._paddingClass} ${this._contentAlignmentClass}` }, this.showNotificationBadge && (index.h("span", { key: 'c2a97e9e72715aa53d2697113eadd214aea29425', class: `flex px-075 ${this._contentAlignmentClass}` }, index.h("wdpr-notification-indicator", { key: 'af779c9f03c1384a380eabda24e0e3cb99620ba1', size: "small", number: this.notificationNumber, decorative: true }))), this._trailingSlot && (index.h("div", { key: 'dc841437b24ddf81d9ca2ba48d43cda6e9853545', class: `flex ${this._contentAlignmentClass} ${this._colorClass}` }, index.h("slot", { key: '4b4c2c2c5b827480f601d07b98f45b0b71d6b10c', name: "trailing-icon", onSlotchange: this._updateSlots }))))));
    }
};

exports.wdpr_nav_item_selectable = WdprNavItemSelectable;
//# sourceMappingURL=wdpr-nav-item-selectable.entry.cjs.js.map

//# sourceMappingURL=wdpr-nav-item-selectable.cjs.entry.js.map