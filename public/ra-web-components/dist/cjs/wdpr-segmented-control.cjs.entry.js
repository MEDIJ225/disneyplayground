...
const WdprSegmentedControl = class {
    ...
    constructor(hostRef) {
        ...
        this.segmentChange = index.createEvent(this, "segmentChange", 7);
        ...
        this._groupId = `segmented-control-${utils.generateRandId()}`;
    ...
    _handleKeyDown = (event) => {
        ...
        let attempts = 0;
        const isForward = key === keycodes_model.KEYBOARD_KEYS.ARROW_RIGHT || key === keycodes_model.KEYBOARD_KEYS.ARROW_DOWN;
    ...
    `;
        ...
        return utils.customTwMerge(baseClasses, heightClass, widthClass, disabledClasses);
    }
    _getSegmentsContainerClasses() {
        ...
        return utils.customTwMerge(baseClasses, widthClass);
    }
    _renderSegments() {
        if (this.options && this.options.length > 0) {
            return this.options.map((option, index$1) => (index.h("wdpr-segment", { label: option.label, value: option.value, iconName: option.iconName, disabled: option.disabled || this.disabled, variant: this.withIcons ? 'icon-label' : 'label-only', selected: this.selectedIndex === index$1, index: index$1, name: this.name || this._groupId, segmentId: `${this._groupId}-option-${index$1}` })));
        }
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '52f84c0deddb06edbc7537c20f620ddabc17a9d6' }, index.h("div", { key: '97e65b4251bf9f33b70a511945a00c147832aab5', class: this._getContainerClasses(), role: "radiogroup", "aria-label": groupLabel, "aria-required": this.required ? 'true' : undefined, "aria-disabled": this.disabled ? 'true' : undefined, "aria-describedby": describedBy, onKeyDown: this._handleKeyDown }, index.h("div", { key: 'be3c269645150fd97cc2e29262b062eba25ee4b5', class: this._getSegmentsContainerClasses() }, this._renderSegments())), this.helperText && (index.h("div", { key: '2be7635376fccb177fd84a0efe1eac7f43ff3008', id: this._helperTextId, class: "helper-text text-text-disclaimer component-small mt-100" }, this.helperText))));
    }
...
exports.wdpr_segmented_control = WdprSegmentedControl;
//# sourceMappingURL=wdpr-segmented-control.entry.cjs.js.map

//# sourceMappingURL=wdpr-segmented-control.cjs.entry.js.map