...
const WdprProgressSegment = class {
    ...
    render() {
        return (index.h("div", { key: '5da5683e558bb889a647eb3fed6bcacf7d8ff8dc', class: `relative h-075 w-full ${this._bgClass} ${this._roundingClass} ${this._terminatorClass}`, part: "segment", "aria-hidden": "true", style: { '--wdpr-terminator': 'var(--theme-dimension-075)' } }, this.status !== 'complete' && this.position === 'end' && (index.h("div", { key: '802e7408b14b7491fb78f335470619f51dca1edf', class: "absolute top-[1px] right-[1px] w-dimension-050 h-dimension-050 shrink-0 bg-surface-neutral-extra-dark rounded-pill", part: "stop-indicator" }))));
    }
};

exports.wdpr_progress_segment = WdprProgressSegment;
//# sourceMappingURL=wdpr-progress-segment.entry.cjs.js.map

//# sourceMappingURL=wdpr-progress-segment.cjs.entry.js.map