...
const WdprCheckbox = class {
    ...
    componentWillLoad() {
        this.internalId = this.inputId || `wdpr-checkbox-${utils.generateRandId()}`;
    }
    componentDidLoad() {
    ...
    get wrapperClass() {
        ...
        return utils.customTwMerge(wrapperBaseClasses, wrapperFocusVisibleClasses, cursorClass, positionClass);
    }
    get fakeCheckboxClass() {
        ...
        return utils.customTwMerge(checkboxBaseClasses, defaultClasses, activeClasses, hoverClasses, checkboxDisabledClasses, forcedStateClasses);
    }
    get labelClass() {
        const srOnlyClass = this.labelPosition === 'none' && 'sr-only';
        const errorColorClass = 'text-text-status-critical';
        return utils.customTwMerge(labelBaseClasses, srOnlyClass, this.error ? errorColorClass : null);
    }
    render() {
        ...
        const CheckmarkIcon = (index.h("div", { key: 'b2844af619fc6a5118d8b1e27b1e1a73e960144a', class: "size-150" }, index.h("wdpr-icon-library", { key: '44633517f575bf4efc3a949d84b123f89f9fdf4f', icon: "checkmark", size: "xsmall", decorative: true })));
        const IndeterminateIcon = (index.h("div", { key: '5086e3f45733856f591d0bd63589bd2b9f0a6a7d', class: "size-150" }, index.h("wdpr-icon-library", { key: 'fb1df061ed16573f70571614293a0651ebfe5954', icon: "none-na-dash", size: "xsmall", decorative: true })));
        const CheckboxControl = (index.h(index.Fragment, { key: 'ea4c3238d5fede458ec9293d628bcfd6ee079efc' }, index.h("input", { key: '861d473e47ca84bc60b746220627016972b729d0', type: "checkbox", class: "sr-only peer", id: this.internalId, checked: this.checked && !this.indeterminate, disabled: this.disabled, readonly: this.readonly, required: this.required, name: this.name, value: this.value, "aria-checked": this.getAriaChecked(), "aria-labelledby": this.customAriaLabelledBy || null, "aria-label": !this.customAriaLabelledBy ? (this.customAriaLabel || (this.labelPosition === 'none' ? this.label : null)) : null, "aria-invalid": this.error ? 'true' : 'false', "aria-describedby": hasErrorDescription ? `${this.internalId}-error` : null, "aria-readonly": this.readonly ? 'true' : null, "aria-required": this.required ? 'true' : null, tabindex: tabindex, onInput: this.handleInputChange }), index.h("span", { key: '299809982571ab6ccbfcb4390c3c53a4b6a72a0f', class: this.fakeCheckboxClass }, this.indeterminate ? IndeterminateIcon : this.checked ? CheckmarkIcon : null)));
        const LabelContent = (index.h("span", { key: '02dcdf8db690df3e5a6b2225aa68454847d7f427', id: labelId, class: this.labelClass, part: "label", innerHTML: !hasSlottedContent ? this.label : '' }, hasSlottedContent && index.h("slot", { key: 'e932cea67cd11159bd29f0a62ee305bb12f05757' })));
        return (index.h(index.Host, { key: 'af1fdbba4e6c8bf37dc680006ff3cf2658be0f17' }, index.h("label", { key: 'e4e868fbe207851311de3a1c30d4f6edadcd9593', htmlFor: this.internalId, class: this.wrapperClass, part: "wrapper" }, CheckboxControl, this.labelPosition !== 'none' && (this.label || hasSlottedContent) && LabelContent), hasErrorDescription && index.h("wdpr-inline-message", { key: '307168507d6fdf68ebf418f3941080899e29033d', variant: "error", size: "small", id: `${this.internalId}-error` }, this.errorMessage)));
    }
...
exports.wdpr_checkbox = WdprCheckbox;
//# sourceMappingURL=wdpr-checkbox.entry.cjs.js.map

//# sourceMappingURL=wdpr-checkbox.cjs.entry.js.map