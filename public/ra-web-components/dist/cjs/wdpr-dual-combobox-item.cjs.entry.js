...
const WdprDualComboboxItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: '41bfc742f0dcaf131af1ef95fe298c2a0cae044c', id: this._internalId, role: "option", "data-dual-combobox-item": true, "aria-selected": this.selected.toString(), "aria-disabled": this.disabled.toString(), onClick: () => this._handleSelection(), class: `${this.isHidden ? 'hidden' : ''}` }, index.h("div", { key: '4a9faffce493a31bf7cd0d1a1e56720949572f74', class: this._singleSelectionClasses }, index.h("slot", { key: 'b576650fcf457b5c15c92a3997cc0c56d79bd175', name: "icon" }), index.h("div", { key: 'f1eb9390e4a061128c9c7a5acea915f007e901fa', class: "flex flex-col gap-050 items-start" }, this.label && index.h("span", { key: 'cf25f62b2b41cd291de07c7930f61273d97535f1', class: "body-large text-start line-clamp-2" }, this.label), this.description && index.h("span", { key: '5211c1d1d31b349e1715444e32d197c023875c04', class: "body-small text-start line-clamp-2" }, this.description))), !this._hideDivider && (index.h("div", { key: '7e9fde613b31d1339ab169dbf6e4d2cedfef8299', class: "mx-100", "aria-hidden": "true" }, index.h("wdpr-divider", { key: '07da1d0f142f1c9d03aa58f5d77db72d99d6ee04' })))));
    }
};
...
exports.wdpr_dual_combobox_item = WdprDualComboboxItem;
//# sourceMappingURL=wdpr-dual-combobox-item.entry.cjs.js.map

//# sourceMappingURL=wdpr-dual-combobox-item.cjs.entry.js.map