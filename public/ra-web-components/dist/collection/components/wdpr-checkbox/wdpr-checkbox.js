...
export class WdprCheckbox {
    ...
    static get is() { return "wdpr-checkbox"; }
    static get encapsulation() { return "shadow"; }
    static get formAssociated() { return true; }
    static get styles() { return ":host { display: flex; flex-direction: column; align-items: flex-start; min-width: 0; max-width: 100%; box-sizing: border-box; }"; }
    static get properties() {
        return {
            ...
            "name": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Name used when participating in form submission."
                },
                "getter": false,
                "setter": false,
                "reflect": true
            },
            "cycleOnIndeterminateClick": {
                "type": "string",
                "attribute": "cycle-on-indeterminate-click",
                "mutable": false,
                "complexType": {
                    "original": "IndeterminateClickCycle",
                    "resolved": "\"checked\" | \"unchecked\"",
                    "references": {
                        "IndeterminateClickCycle": {
                            "location": "import",
                            "path": "./wdpr-checkbox.model",
                            "id": "src/components/wdpr-checkbox/wdpr-checkbox.model.ts::IndeterminateClickCycle"
                        }
                    }
                },
                "required": false,
                ...
                "docs": {
                    "tags": [],
                    "text": "The cycle behavior when the user clicks on an indeterminate checkbox.\nIf set to `checked`, the checkbox will be set to checked when clicked.\nIf set to `unchecked`, the checkbox will be set to unchecked when clicked."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "customTabindex": {
                ...
                "docs": {
                    "tags": [],
                    "text": "The tab index for keyboard navigation. Defaults to `0` for focusable elements."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "customAriaLabel": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Provides an accessible name for the checkbox, by default the label is the aria label"
                },
                "getter": false,
                "setter": false,
                "reflect": true
            ...
            "customAriaLabelledBy": {
                ...
                "docs": {
                    "tags": [],
                    "text": "References the `id` of an external element to use as the accessible name for the checkbox.\nUse this when the label is rendered outside the component (e.g. a styled heading).\nTakes precedence over `a11y-label` and the default label association."
                },
                "getter": false,
                "setter": false,
                "reflect": true
            ...
            "labelPosition": {
                ...
                "complexType": {
                    ...
                    "references": {
                        "LabelPosition": {
                            "location": "import",
                            "path": "./wdpr-checkbox.model",
                            "id": "src/components/wdpr-checkbox/wdpr-checkbox.model.ts::LabelPosition"
                        }
                    }
                },
                "required": false,
                ...
                "docs": {
                    "tags": [],
                    "text": "Defines the label's position relative to the checkbox.\n`trailing`: Checkbox on the left, label on the right (default).\n`leading`: Label on the left, checkbox on the right.\n`none`: the label is visually hidden but remains accessible to screen readers."
                },
                "getter": false,
                "setter": false,
                "reflect": true,
            ...
            "error": {
                ...
                "docs": {
                    "tags": [],
                    "text": "If `true`, displays the checkbox in an error state."
                },
                "getter": false,
                "setter": false,
                "reflect": true,
            ...
            "errorMessage": {
                ...
                "docs": {
                    "tags": [],
                    "text": "An optional error message to be displayed and announced by screen readers."
                },
                "getter": false,
                "setter": false,
                "reflect": true
            ...
            "readonly": {
                ...
                "docs": {
                    "tags": [],
                    "text": "If `true`, the checkbox is read-only. The user can focus on it but not change its state."
                },
                "getter": false,
                "setter": false,
                "reflect": true,
            ...
            "indeterminate": {
                ...
                "docs": {
                    "tags": [],
                    "text": "The indeterminate state of the checkbox. This takes precedence over `checked`."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "value": {
                ...
                "docs": {
                    "tags": [],
                    "text": "The value submitted with forms when the checkbox is checked."
                },
                "getter": false,
                "setter": false,
                "reflect": true,
            ...
            "forceHover": {
                ...
                "docs": {
                    "tags": [],
                    "text": "If `true`, forces the checkbox to display its hover state.\nUseful when parent components need to control hover appearance."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "forceActive": {
                ...
                "docs": {
                    "tags": [],
                    "text": "If `true`, forces the checkbox to display its active/pressed state.\nUseful when parent components need to control pressed appearance."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
...
//# sourceMappingURL=wdpr-checkbox.js.map
