...
export class WdprCameraScanner {
    el;
    ...
    static get is() { return "wdpr-camera-scanner"; }
    ...
    static get properties() {
        return {
            "instruction": {
                ...
                "setter": false,
                "reflect": false,
                "defaultValue": "'Center the Code Here'"
            },
            "aspect": {
                "type": "string",
                "attribute": "aspect",
                "mutable": false,
                "complexType": {
                    "original": "WdprCameraScannerAspect",
                    "resolved": "\"16x9\" | \"1x1\"",
                    "references": {
                        "WdprCameraScannerAspect": {
                            "location": "local",
                            "path": "/harness/packages/stencil-library/src/components/wdpr-camera-scanner/wdpr-camera-scanner.tsx",
                            "id": "src/components/wdpr-camera-scanner/wdpr-camera-scanner.tsx::WdprCameraScannerAspect"
                        }
                    }
                },
                "required": false,
            ...
            "size": {
                ...
                "mutable": false,
                "complexType": {
                    "original": "WdprCameraScannerSize",
                    "resolved": "\"lg\" | \"md\" | \"sm\"",
                    "references": {
                        "WdprCameraScannerSize": {
                            "location": "local",
                            "path": "/harness/packages/stencil-library/src/components/wdpr-camera-scanner/wdpr-camera-scanner.tsx",
                            "id": "src/components/wdpr-camera-scanner/wdpr-camera-scanner.tsx::WdprCameraScannerSize"
                        }
                    }
                },
                "required": false,
                ...
                "docs": {
                    "tags": [],
                    "text": "Preset sizes from design system"
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "width": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Custom width (overrides size). Example: '280px', 'min(90vw, 360px)'"
                },
                "getter": false,
                "setter": false,
                "reflect": false
...
//# sourceMappingURL=wdpr-camera-scanner.js.map
