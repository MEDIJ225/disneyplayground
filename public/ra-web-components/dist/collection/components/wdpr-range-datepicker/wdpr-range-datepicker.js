...
import { wrapperTextFieldClasses } from "../wdpr-datepicker/wdpr-datepicker.model";
export class WdprRangeDatePicker {
    /**
    ...
    get _calendarWrapperClasses() {
        ...
        return twMerge(baseClasses, shadowClass, _expandedClasses);
    }
    ...
    static get is() { return "wdpr-range-datepicker"; }
        ...
        return {
            ...
            "startLabel": {
                ...
                "docs": {
                    ...
                    "text": "The start label for the input."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
                "defaultValue": "'Start Label'"
            },
            "endLabel": {
                "type": "string",
                "attribute": "end-label",
                ...
                "docs": {
                    ...
                    "text": "The end label for the input."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
                "defaultValue": "'End Label'"
            },
            "format": {
                "type": "string",
                "attribute": "format",
            ...
            "start": {
                ...
                "docs": {
                    ...
                    "text": "Default start date for range selection .\nMust follow the format specified in the `format` prop."
                },
                "getter": false,
                "setter": false,
                "reflect": true
            ...
            "end": {
                ...
                "docs": {
                    ...
                    "text": "Default end date for range selection.\nMust follow the format specified in the `format` prop."
                },
                "getter": false,
                "setter": false,
                "reflect": true
            ...
            "startName": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Name for the start date in form submission."
                },
                "getter": false,
                "setter": false,
                "reflect": false
            ...
            "endName": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Name for the end date in form submission."
                },
                "getter": false,
                "setter": false,
                "reflect": false
            ...
            "min": {
                ...
                "setter": false,
                "reflect": true,
                "defaultValue": "formatDateToString(new Date(0, 0, 1), this.format)"
            },
            "max": {
                "type": "string",
                "attribute": "max",
    ...
    static get events() {
        return [{
                ...
                "docs": {
                    "tags": [{
                            "name": "event",
                            "text": "rangeDatesSelected"
                        }, {
                            "name": "type",
                            "text": "{CustomEvent<{ startDate?: string; endDate?: string }>}"
                        }, {
                            "name": "property",
                            "text": "{string} [startDate] - Start date as an ISO string (e.g. \"2025-06-19\")."
                        }, {
                            "name": "property",
                            "text": "{string} [endDate] - End date as an ISO string (e.g. \"2025-06-25\")."
                        }],
                    "text": "Fired when a valid range of dates is selected."
                },
                "complexType": {
                ...
                "docs": {
                    "tags": [{
                            ...
                            "name": "type",
                            "text": "{CustomEvent<{ type: 'invalid-format' | 'out-of-range' | 'invalid-range'; start?: string; end?: string }>}"
                        }, {
                            "name": "property",
                            "text": "{'invalid-format' | 'out-of-range' | 'invalid-range'} type - Type of invalidity."
                        }, {
                            "name": "property",
                            "text": "{string} [start] - Start date as an ISO string (if provided)."
                        }, {
                            "name": "property",
                            "text": "{string} [end] - End date as an ISO string (if provided)."
                        }],
                    "text": "Fired when an invalid date input is detected (wrong format, out of range, or invalid range)."
                },
                "complexType": {
                    "original": "{ type: 'invalid-format' | 'out-of-range' | 'invalid-range'; start?: string; end?: string }",
                    "resolved": "{ type: \"out-of-range\" | \"invalid-format\" | \"invalid-range\"; start?: string; end?: string; }",
                    "references": {}
                }
            }];
    }
