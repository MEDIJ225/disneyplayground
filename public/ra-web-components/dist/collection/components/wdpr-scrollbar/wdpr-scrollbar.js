...
export class WdprScrollbar {
    ...
    get trackClass() {
        const isVertical = this.orientation === 'vertical';
        const baseClasses = customTwMerge('scroll-track absolute cursor-pointer rounded transition-opacity duration-300 bg-surface-neutral-light', this.isVisible ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none');
        const positionClasses = isVertical
            ? customTwMerge('right-[4px] top-[2px] bottom-[2px]', this.size === 'small' && 'w-[6px]', this.size === 'medium' && 'w-[8px]', this.size === 'large' && 'w-[12px]')
            : customTwMerge('bottom-[4px] left-[2px] right-[2px]', this.size === 'small' && 'h-[6px]', this.size === 'medium' && 'h-[8px]', this.size === 'large' && 'h-[12px]');
        return customTwMerge(baseClasses, positionClasses);
    }
    get thumbClass() {
        const isVertical = this.orientation === 'vertical';
        const baseClasses = customTwMerge('scroll-thumb absolute rounded transition-colors duration-200', this.isDragging ? 'cursor-grabbing bg-surface-actionable-alt-default' : 'cursor-grab bg-surface-neutral-dark', isVertical ? 'w-full' : 'h-full');
        return baseClasses;
    }
    render() {
        const isVertical = this.orientation === 'vertical';
        return (h("div", { key: '832bdccbe47b25e601fe130daa2f27f47b810c6c', class: this.wrapperClass, onMouseEnter: () => {
                this.isHovering = true;
                this.showScrollbar();
            }, onMouseLeave: () => {
                this.isHovering = false;
                this.hideScrollbarAfterDelay();
            } }, h("div", { key: '1af3b96c50f7a73dec936a31f39e3eb55e82aa5c', class: this.containerClass }, h("div", { key: '3e1567a3031a21b98e29aa349bf0fa0f85a87617', class: this.contentClass, tabindex: "0", role: "region", "aria-label": `Scrollable content, ${this.orientation} orientation`, onFocus: this.handleFocus, onBlur: this.handleBlur }, h("slot", { key: '492eb61b63b68e3fa2775d909d20ebbe4069e9f7' }))), h("div", { key: '394620b0256d60f1b231208106718f62eeec2a93', class: this.trackClass, onClick: this.handleTrackClick.bind(this) }, h("div", { key: 'f3e33e8f1bc91ec184b9136bfe9517aea08cfe35', class: this.thumbClass, tabindex: "-1", style: {
    ...
    static get is() { return "wdpr-scrollbar"; }
    static get encapsulation() { return "shadow"; }
    static get styles() { return ".scrollbar-hide {\n      scrollbar-width: none;\n      -ms-overflow-style: none;\n    }\n    .scrollbar-hide::-webkit-scrollbar {\n      display: none;\n    }"; }
    static get properties() {
        return {
            "orientation": {
                ...
                "mutable": false,
                "complexType": {
                    "original": "ScrollbarOrientation",
                    "resolved": "\"horizontal\" | \"vertical\"",
                    "references": {
                        "ScrollbarOrientation": {
                            "location": "local",
                            "path": "/harness/packages/stencil-library/src/components/wdpr-scrollbar/wdpr-scrollbar.tsx",
                            "id": "src/components/wdpr-scrollbar/wdpr-scrollbar.tsx::ScrollbarOrientation"
                        }
                    }
                },
                "required": false,
            ...
            "size": {
                ...
                "mutable": false,
                "complexType": {
                    "original": "ScrollbarSize",
                    "resolved": "\"large\" | \"medium\" | \"small\"",
                    "references": {
                        "ScrollbarSize": {
                            "location": "local",
                            "path": "/harness/packages/stencil-library/src/components/wdpr-scrollbar/wdpr-scrollbar.tsx",
                            "id": "src/components/wdpr-scrollbar/wdpr-scrollbar.tsx::ScrollbarSize"
                        }
                    }
                },
                "required": false,
    ...
    static get events() {
        return [{
                ...
                "complexType": {
                    "original": "{ position: number; percentage: number }",
                    "resolved": "{ position: number; percentage: number; }",
                    "references": {}
                }
            }, {
                "method": "positionInitialized",
    ...
    static get watchers() {
        return [{
                ...
                "propName": "initialPosition",
                "methodName": "handleInitialPositionChange"
            }];
    }
}
//# sourceMappingURL=wdpr-scrollbar.js.map
