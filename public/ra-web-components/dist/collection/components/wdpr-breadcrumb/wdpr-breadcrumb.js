...
import { measureBreadcrumbWidths, waitForStableLayout } from "./wdpr-breadcrumb.utils";
export class WdprBreadcrumb {
    _initialized = false;
    /**
    ...
    static get is() { return "wdpr-breadcrumb"; }
    ...
    static get properties() {
        return {
            "wrapMode": {
                ...
                "mutable": false,
                "complexType": {
                    "original": "BreadcrumbWrapMode",
                    "resolved": "\"line\" | \"truncation\"",
                    "references": {
                        "BreadcrumbWrapMode": {
                            "location": "import",
                            "path": "./wdpr-breadcrumb.model",
                            "id": "src/components/wdpr-breadcrumb/wdpr-breadcrumb.model.ts::BreadcrumbWrapMode"
                        }
                    }
                },
                "required": false,
                ...
                "docs": {
                    ...
                    "text": "Controls how breadcrumbs behave when they overflow the container.\n- `'truncation'`: Shows a truncation icon button, clicking it expands all breadcrumbs\n- `'line'`: Breadcrumbs wrap to the next line automatically"
                },
                "getter": false,
                "setter": false,
                "reflect": true,
                "defaultValue": "'truncation'"
            }
        };
    }
    static get states() {
...
//# sourceMappingURL=wdpr-breadcrumb.js.map
