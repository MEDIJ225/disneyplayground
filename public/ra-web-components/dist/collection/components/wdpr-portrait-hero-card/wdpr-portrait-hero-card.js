...
export class WdprPortraitHeroCard {
    headline;
    body;
    src;
    gradient = 'accent-6';
    ...
    static get is() { return "wdpr-portrait-hero-card"; }
        ...
        return {
            ...
            "gradient": {
                ...
                "complexType": {
                    ...
                    "resolved": "\"accent-1\" | \"accent-10\" | \"accent-2\" | \"accent-3\" | \"accent-4\" | \"accent-5\" | \"accent-6\" | \"accent-7\" | \"accent-8\" | \"accent-9\"",
                    "references": {
                        "GradientColor": {
                            "location": "import",
                            "path": "./wdpr-portrait-hero-card.model",
                            "id": "src/components/wdpr-portrait-hero-card/wdpr-portrait-hero-card.model.ts::GradientColor"
                        }
                    }
                },
                "required": false,
