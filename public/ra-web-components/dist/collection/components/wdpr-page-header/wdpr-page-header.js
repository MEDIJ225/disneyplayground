...
export class WdprPageHeader {
    ...
    static get is() { return "wdpr-page-header"; }
    ...
    static get properties() {
        return {
            "titleText": {
                ...
                "docs": {
                    "tags": [],
                    "text": "The title text to be displayed in the header."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "ariaLiveMode": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Controls the aria-live attribute for the title text."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "background": {
                ...
                "mutable": false,
                "complexType": {
                    "original": "PageHeaderBackground",
                    "resolved": "\"media\" | \"primary\" | \"secondary\" | \"translucent\" | \"transparent\"",
                    "references": {
                        "PageHeaderBackground": {
                            "location": "local",
                            "path": "/harness/packages/stencil-library/src/components/wdpr-page-header/wdpr-page-header.tsx",
                            "id": "src/components/wdpr-page-header/wdpr-page-header.tsx::PageHeaderBackground"
                        }
                    }
                },
                "required": false,
            ...
            "inverse": {
                ...
                "docs": {
                    "tags": [],
                    "text": "If true, sets the content color to inverse (light text) for dark backgrounds."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
    ...
    static get events() {
        return [{
                ...
                "docs": {
                    "tags": [],
                    "text": "On right icon click event"
                },
                "complexType": {
                    "original": "boolean",
                    "resolved": "boolean",
...
//# sourceMappingURL=wdpr-page-header.js.map
