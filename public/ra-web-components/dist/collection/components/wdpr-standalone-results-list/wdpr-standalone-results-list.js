...
import { isStandaloneResultsListItemElement } from "./wdpr-standalone-results-list.model";
import { customTwMerge } from "../../utils/utils";
export class WdprStandaloneResultsList {
    el;
    ...
    static get is() { return "wdpr-standalone-results-list"; }
    ...
    static get events() {
        return [{
                ...
                "complexType": {
                    "original": "{ selectedValues: string[] }",
                    "resolved": "{ selectedValues: string[]; }",
                    "references": {}
                }
            }];
    }
