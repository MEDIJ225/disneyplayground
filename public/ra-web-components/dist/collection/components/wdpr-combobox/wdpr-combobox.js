...
import { isComboboxItemElement, } from "./wdpr-combobox.model";
import { generateRandId } from "../../utils/utils";
import { renderTags, calculateVisibleTags, createTagsResizeObserver } from "./wdpr-combobox-multiselect.helpers";
import { KEYBOARD_KEYS } from "../../models/keycodes.model";
import { findNextEnabledIndex, getInitialFocusIndex, itemMatchesFilter } from "./wdpr-combobox.utils";
export class WdprCombobox {
    _listId;
    _textFieldId;
    _tagsContainerRef;
    _resizeObserver;
    ...
    static get is() { return "wdpr-combobox"; }
    ...
    static get properties() {
        return {
            ...
            "filterMode": {
                ...
                "mutable": false,
                "complexType": {
                    "original": "ComboboxFilterMode",
                    "resolved": "\"auto\" | \"manual\"",
                    "references": {
                        "ComboboxFilterMode": {
                            "location": "import",
                            "path": "./wdpr-combobox.model",
                            "id": "src/components/wdpr-combobox/wdpr-combobox.model.ts::ComboboxFilterMode"
                        }
                    }
                },
                "required": false,
            ...
            "location": {
                ...
                "mutable": false,
                "complexType": {
                    "original": "ComboboxLocation",
                    "resolved": "\"above\" | \"below\"",
                    "references": {
                        "ComboboxLocation": {
                            "location": "import",
                            "path": "./wdpr-combobox.model",
                            "id": "src/components/wdpr-combobox/wdpr-combobox.model.ts::ComboboxLocation"
                        }
                    }
                },
                "required": false,
                ...
                "complexType": {
                    ...
                    "references": {
                        "TextFieldRequirementIndicator": {
                            "location": "import",
                            "path": "../wdpr-text-field/wdpr-text-field.model",
    ...
    static get watchers() {
        return [{
                ...
                "methodName": "handleLeadingInputValueChange"
            }, {
