...
export class WdprDate {
    ...
    get _dotClasses() {
        return twMerge(this.cellData.selected || this.cellData.isStartDate || this.cellData.isEndDate ? 'bg-surface-default' : '');
    }
    render() {
        const key = this.cellData && formatDateToString(this.cellData.date, this.format);
    ...
    static get is() { return "wdpr-date"; }
    ...
    static get properties() {
        return {
            "cellData": {
                ...
                "complexType": {
                    "original": "CellData",
                    "resolved": "CellDataBase",
                    "references": {
                        "CellData": {
                            "location": "import",
                            "path": "./wdpr-date.model",
                            "id": "src/components/wdpr-calendar/wdpr-date/wdpr-date.model.ts::CellData"
                        }
                    }
                },
                "required": false,
                ...
                "docs": {
                    ...
                    "text": "Data for this calendar cell.\nContains the date and state flags for rendering."
                },
                "getter": false,
                "setter": false
            },
            "isFocusable": {
                ...
                "docs": {
                    ...
                    "text": "Whether this cell should receive keyboard focus.\nUsed for roving tabindex and keyboard navigation."
                },
                "getter": false,
                "setter": false,
                "reflect": true,
            ...
            "extras": {
                ...
                "docs": {
                    ...
                    "text": "The Extra info for the date cell"
                },
                "getter": false,
                "setter": false
            },
...
//# sourceMappingURL=wdpr-date.js.map
