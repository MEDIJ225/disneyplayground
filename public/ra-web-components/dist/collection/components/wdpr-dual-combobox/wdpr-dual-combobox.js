...
import { isDualComboboxItemElement, } from "./wdpr-dual-combobox.model";
import { KEYBOARD_KEYS } from "../../models/keycodes.model";
import { generateRandId } from "../../utils/utils";
import { findNextEnabledIndex, getInitialFocusIndex, itemMatchesFilter, splitLabel } from "./wdpr-dual-combobox.utils";
export class WdprDualCombobox {
    _listId;
    _slotObserver;
    _listEl = null;
    _cachedItems = null;
    ...
    static get is() { return "wdpr-dual-combobox"; }
    static get encapsulation() { return "scoped"; }
    static get formAssociated() { return true; }
    static get originalStyleUrls() {
        return {
            "$": ["wdpr-dual-combobox.css"]
        };
    }
    ...
    static get properties() {
        return {
                ...
                "complexType": {
                    ...
                    "references": {
                        "DualTextFieldRequirementIndicator": {
                            "location": "import",
                            "path": "../wdpr-dual-text-field/wdpr-dual-text-field.model",
            ...
            "filterMode": {
                ...
                "mutable": false,
                "complexType": {
                    "original": "DualComboboxFilterMode",
                    "resolved": "\"auto\" | \"manual\"",
                    "references": {
                        "DualComboboxFilterMode": {
                            "location": "import",
                            "path": "./wdpr-dual-combobox.model",
                            "id": "src/components/wdpr-dual-combobox/wdpr-dual-combobox.model.ts::DualComboboxFilterMode"
                        }
                    }
                },
                "required": false,
            ...
            "location": {
                ...
                "mutable": false,
                "complexType": {
                    "original": "DualComboboxLocation",
                    "resolved": "\"above\" | \"below\"",
                    "references": {
                        "DualComboboxLocation": {
                            "location": "import",
                            "path": "./wdpr-dual-combobox.model",
                            "id": "src/components/wdpr-dual-combobox/wdpr-dual-combobox.model.ts::DualComboboxLocation"
                        }
                    }
                },
                "required": false,
            ...
            "toggleButtonAriaLabelClosed": {
                "type": "string",
                "attribute": "toggle-button-aria-label-closed",
                "mutable": false,
                "complexType": {
                    "original": "string",
                    "resolved": "string",
            ...
            "toggleButtonAriaLabelOpen": {
                "type": "string",
                "attribute": "toggle-button-aria-label-open",
                "mutable": false,
                "complexType": {
                    "original": "string",
                    "resolved": "string",
    ...
    static get watchers() {
        return [{
                ...
                "methodName": "handleControlledValueChange"
            }, {
                ...
                "propName": "_leadingInputValue",
                "methodName": "handleInputValueChange"
            }, {
                "propName": "_trailingInputValue",
                "methodName": "handleInputValueChange"
            }];
    }
