...
export class WdprIcon {
    ...
    static get is() { return "wdpr-icon"; }
            ...
            "size": {
                ...
                "complexType": {
                    ...
                    "references": {
                        "IconSize": {
                            "location": "local",
                            "path": "/harness/packages/stencil-library/src/components/wdpr-icon/wdpr-icon.tsx",
                            "id": "src/components/wdpr-icon/wdpr-icon.tsx::IconSize"
                        }
                    }
                },
                "required": false,
                ...
                "complexType": {
                    ...
                    "references": {
                        "IconBackground": {
                            "location": "local",
                            "path": "/harness/packages/stencil-library/src/components/wdpr-icon/wdpr-icon.tsx",
                            "id": "src/components/wdpr-icon/wdpr-icon.tsx::IconBackground"
                        }
                    }
                },
                "required": false,
                ...
                "complexType": {
                    ...
                    "references": {
                        "IconVariant": {
                            "location": "local",
                            "path": "/harness/packages/stencil-library/src/components/wdpr-icon/wdpr-icon.tsx",
                            "id": "src/components/wdpr-icon/wdpr-icon.tsx::IconVariant"
                        }
                    }
                },
                "required": false,
...
//# sourceMappingURL=wdpr-icon.js.map
