...
import { customTwMerge, twMerge, generateRandId } from "../../utils/utils";
import { KEYBOARD_KEYS } from "../../models/keycodes.model";
export class WdprDrawer {
    // ────────────────────────── Public API ─────────────────────────
    el;
    ...
    get _drawerHeaderClasses() {
        ...
        return twMerge('flex px-300 pb-200', paddingTop, justifyContent);
    }
    get _headerClasses() {
    ...
    get _handleClasses() {
        ...
        return twMerge('rounded-pill w-500 h-050', bgColor);
    }
    get _contentClasses() {
        const color = this.colorMode === 'secondary' ? 'bg-surface-default-alt' : 'bg-surface-default';
        return twMerge('min-w-0 min-h-0 flex flex-col flex-1 pt-300 overflow-hidden', color);
    }
    _clickPrimary() {
    ...
    static get is() { return "wdpr-drawer"; }
    ...
    static get properties() {
        return {
            "position": {
                ...
                "complexType": {
                    ...
                    "references": {
                        "DrawerPosition": {
                            "location": "local",
                            "path": "/harness/packages/stencil-library/src/components/wdpr-drawer/wdpr-drawer.tsx",
                            "id": "src/components/wdpr-drawer/wdpr-drawer.tsx::DrawerPosition"
                        }
                    }
                },
                "required": false,
                ...
                "docs": {
                    "tags": [],
                    "text": "Which side the drawer slides from (desktop side-panel mode)."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "colorMode": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Visual theme surface. 'primary' or 'secondary'"
                },
                "getter": false,
                "setter": false,
                "reflect": true,
            ...
            "headerColorMode": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Visual header color mode. 'primary' or 'secondary'"
                },
                "getter": false,
                "setter": false,
                "reflect": true,
            ...
            "isDraggable": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Enable drag on the half-sheet (mobile)."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "halfStackMaxWidth": {
                "type": "number",
                "attribute": "half-stack-max-width",
                "mutable": false,
                "complexType": {
                    "original": "number",
                    "resolved": "number",
                ...
                "docs": {
                    "tags": [],
                    "text": "Half-sheet max width (px). Keeps the sheet centered with margins on large phones/tablets."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "avatarImageSrc": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Avatar image source for mobile half-stack drawer"
                },
                "getter": false,
                "setter": false,
                "reflect": false
            ...
            "initialOpenPercent": {
                "type": "number",
                "attribute": "initial-open-percent",
                "mutable": false,
                "complexType": {
                    "original": "number",
                    "resolved": "number",
                ...
                "docs": {
                    "tags": [],
                    "text": "Optional initial open height for mobile half-sheet (percent of viewport). If omitted, uses auto content height."
                },
                "getter": false,
                "setter": false,
                "reflect": false
